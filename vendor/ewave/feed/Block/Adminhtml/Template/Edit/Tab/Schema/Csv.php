...
use Ewave\Feed\Model\Config\Source\Delimiter as SourceDelimiter;
use Ewave\Feed\Model\Config\Source\Enclosure as SourceEnclosure;
...
class Csv extends Form
{
    ...
    public function __construct(
        ...
        $this->_template = 'Ewave_Feed::template/edit/tab/schema/csv.phtml';
        ...
        return [
            "*" => [
                'Magento_Ui/js/core/app' => [
                    'components' => [
                        'schema_csv' => [
                            'component' => 'Ewave_Feed/js/template/edit/tab/schema/csv',
                            'config' => [
