...
namespace Ewave\Feed\Block\Adminhtml\Rule\Edit;
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('general_section', [
            ...
            'content' => $this->getLayout()
                ->createBlock('\Ewave\Feed\Block\Adminhtml\Rule\Edit\Tab\General')->toHtml(),
        ]);
        ...
        if ($this->registry->registry('current_model')->getId()) {
            $this->addTab('filter_section', [
                ...
                'title' => __('Rules'),
                'content' => $this->getLayout()
                    ->createBlock('\Ewave\Feed\Block\Adminhtml\Rule\Edit\Tab\Rule')->toHtml(),
            ]);
        }
