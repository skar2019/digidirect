...
namespace Ewave\Feed\Block\Adminhtml\Feed;

use Magento\Backend\Block\Template;
use Magento\Backend\Block\Template\Context;
use Magento\Framework\Registry;
use Ewave\Feed\Helper\Data as FeedHelper;
        ...
        return [
            "*" => [
                'Magento_Ui/js/core/app' => [
                    'components' => [
                        'feed_export' => [
                            'component' => 'Ewave_Feed/js/feed/export',
                            'config' => [
                                'exportUrl' => $exportUrl,
                            ...
                            'children' => [
                                'progress' => [
                                    'component' => 'Ewave_Feed/js/feed/progress',
                                    'config' => [
                                        'url' => $progressUrl,
                                        'id' => $this->getFeed()->getId(),
                                    ],
