...
/**
 * @method \Ewave\Feed\Model\ResourceModel\Dynamic\Category getResource()
 */
class Category extends AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'ewave_feed_dynamic_category';
    ...
    {
        $this->_init('Ewave\Feed\Model\ResourceModel\Dynamic\Category');
    }
