...
use Ewave\LayeredNavigation\Model\ResourceModel\FilterSetting\Collection;
...
class FilterSetting extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function allowCategoryMultiSelect()
    {
        return $this->scopeConfig->isSetFlag(
            'ewave_layerednavigation/category/allow_multiselect',
    ...
    public function getCategoryDisplayMode()
    {
        return $this->scopeConfig->getValue(
            'ewave_layerednavigation/category/display_mode',
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'ewave_layerednavigation/category/enable_show_more',
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE
        );
    }
    ...
    public function getCategoryShowMoreCount()
    {
        return (int)$this->scopeConfig->getValue(
            'ewave_layerednavigation/category/options_per_filter',
            \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE
        );
    }
}
