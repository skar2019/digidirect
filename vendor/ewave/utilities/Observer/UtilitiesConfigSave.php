<?php
namespace Ewave\Utilities\Observer;
 ...
 *
 * @package Ewave\Utilities\Observer
 */
class UtilitiesConfigSave implements ObserverInterface
{
    ...
    protected function isActive($scopeCode)
    {
        return (bool)$this->scopeConfig->getValue(
            'ewave_utilities_config/sales_prefix/active',
    ...
    {
        return (bool)$this->scopeConfig->getValue(
            'ewave_utilities_config/sales_prefix/use_store_id_as_prefix',
            ScopeInterface::SCOPE_STORE,
            $scopeCode
        );
    }
    ...
    protected function getPrefix($entityType, $scopeCode)
    {
        return $this->scopeConfig->getValue(
            "ewave_utilities_config/sales_prefix/{$entityType}",
            ScopeInterface::SCOPE_STORE,
            $scopeCode
        );
    }
