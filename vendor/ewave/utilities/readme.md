...
[wiki link](https://wiki.ewave.com/display/LEGO/Utilities)
...
### VERSION 1.1.4.1
  ...
  1. Added custom reader - provide ability to read xml configuration files from directory ewave_xml in root magento directory
...
### VERSION 1.6.0
  ...
  1. Added compatibility with magento 2.2:
     - Removed \Ewave\Utilities\Preference\Magento\Framework\View\Result\Page::render() rewrite
     - Added \Ewave\Utilities\Preference\Magento\Framework\View\Result\Page::renderPage() rewrite. Additional variables are now being assigned in this method

### VERSION 1.7.0

  1. Move functionality of Ewave_Email module to Utilities. Now developer can add new/custom email template variable using next steps:
     - add to di.xml in your module code like this:
     
     `<type name="Ewave\Utilities\Preference\Magento\Framework\Mail\Template\TransportBuilder">
         <arguments>
             <argument name="customTemplateVars" xsi:type="array">
                 <item name="subscriber" xsi:type="object">Ewave\Newsletter\Model\MailTemplateCustomVar</item>
             </argument>
         </arguments>
      </type>
     `
     
     - create a class (for example Ewave\Newsletter\Model\MailTemplateCustomVar) and realize logic of new/custom email template variable getting in getVars(\Magento\Framework\Mail\Template\TransportBuilder $subject, array $templateVars = null) method (example you can see in Ewave_Newsletter module)
...
### VERSION 1.8.0
  ...
  1. Ability to override XSD schemes:
    ...
    `<type name="Ewave\Utilities\Plugin\Magento\Framework\Config\Dom\UrnResolver">
          <arguments>
              <argument name="overwrittenSchemas" xsi:type="array">
                  <item name="urn:magento:framework:Config/etc/view.xsd" xsi:type="string">urn:ewave:module:Ewave_Utilities:etc/view.xsd</item>
              </argument>
          </arguments>
      </type>
...
### VERSION 1.12.0
   ...
   1. System Configuration Form Creation
        - Ewave\Utilities\Model\Source\AttributeList - get all attribute in format ['attr_code' => 'attr_label'] 
        you can config it like 
        `<virtualType name="Ewave\B2bMyStore\Model\Source\AbstractEntity\AttributeList" type="Ewave\Utilities\Model\Source\AttributeList">
            <arguments>
                <argument name="entity" xsi:type="const">\Ewave\AbstractEntity\Model\AbstractEntity::ENTITY_TYPE</argument>
            </arguments>
        </virtualType>`
        - Ewave\Utilities\Block\Adminhtml\Config\Form\Field\Attribute\Renderer\AbstractRenderer -
        default select renderer who take options from Ewave\Utilities\Model\Source\AttributeList. Example:
        `<virtualType name="Ewave\B2bMyStore\Block\Adminhtml\Config\Form\Field\Attribute\Renderer\AbstractEntity"
              ype="Ewave\Utilities\Block\Adminhtml\Config\Form\Field\Attribute\Renderer\AbstractRenderer">
            <arguments>
                <argument name="attributeList" xsi:type="object">Ewave\B2bMyStore\Model\Source\AbstractEntity\AttributeList</argument>
            </arguments>
        </virtualType>`
        - Ewave\Utilities\Block\Adminhtml\Config\Form\Field\Relation dynamic form. Example:
        `<virtualType name="Ewave\B2bMyStore\Block\Relation" type="Ewave\Utilities\Block\Adminhtml\Config\Form\Field\Relation">
           <arguments>
                 <argument name="config" xsi:type="array">
                      item name="address" xsi:type="array">
                         <item name="class" xsi:type="object">Ewave\B2bMyStore\Block\Adminhtml\Config\Form\Field\Attribute\Renderer\ExtendedTeam</item>
...
### VERSION 1.14.0
   ...
   `<type name="Ewave\Utilities\Preference\Magento\Framework\Mail\Template\TransportBuilder">
       <arguments>
           <argument name="customTemplateVars" xsi:type="array">
               <item name="example_1" xsi:type="object">Ewave\Utilities\Model\CustomTemplateVarsInterface</item>
               <item name="example_2" xsi:type="array">
                   <item name="vars_model" xsi:type="object">Ewave\Utilities\Model\CustomTemplateVarsInterface</item>
   ...
   2. Ability to get any custom variables or config using Ewave Utilities helper
   `<?php echo $this->helper('Ewave\Utilities\Helper\Data')->getCustomVariable('custom_variable_code'); ?>`
   `<?php echo $this->helper('Ewave\Utilities\Helper\Data')->getConfig('some/config/path'); ?>`
        ...
        <field name="abstract_entity_id">
            <argument name="data" xsi:type="array">
                <item name="config" xsi:type="array">
                    <item name="component" xsi:type="string">Ewave_Utilities/js/form/element/ajax-auto-complete</item>
                    <item name="url" xsi:type="url" path="ewave_advancedpricing/advancedpricing/entitySearch"/>
...
### VERSION 1.16.3
   ...
   2. Added Store Helper. You can get current Store Information:
      $store = $this->helper(Ewave\Utililties\Helper\Frontend\Store)->getCurrentStore();
      echo $store->getName()
...
### VERSION 1.18.1
   1. Added class \Ewave\Utilities\Model\Checkout\Cart\Add\MessageManager to solve the conflict of message customisations. You can use this class to change the text of default message (example: "Ewave_Collect") or add additional logic (example: "Ewave_ExtendedCart").
