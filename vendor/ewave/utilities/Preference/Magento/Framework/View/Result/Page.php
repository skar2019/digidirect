...
namespace Ewave\Utilities\Preference\Magento\Framework\View\Result;
...
class Page extends \Magento\Framework\View\Result\Page
{
     ...
     *
     * @var \Ewave\Utilities\Helper\Animation
     */
     ...
     * @param \Ewave\Utilities\Helper\Animation $animation
    ...
    public function __construct(
        ...
        \Ewave\Utilities\Helper\Animation $animation,
        $template,
        $isIsolated = false
    ) {
        parent::__construct(
