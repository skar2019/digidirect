    ...
    var Component = function () {
        ...
        _createClass(Component, [{
            ...
            value: function bind(options, mode) {
                switch (mode) {
                    case 'post':
                        (0, _ewaveUtils.loadView)(options, this, 'Ewave_AddressVerification/js/dist/views/post', 'Address Verification (Post)');
                        break;
                    default:
                        (0, _ewaveUtils.loadView)(options, this, 'Ewave_AddressVerification/js/dist/views/index', 'Address Verification (Google API)');
                }
            }
        }, {
            key: 'fetchData',
