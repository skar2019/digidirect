<?php
namespace Ewave\AddressVerification\Controller\Adminhtml\Index;
...
use Ewave\AddressVerification\Model\Import as ImportModel;
use Symfony\Component\Config\Definition\Exception\Exception;

/**
 * Class Import
 * @package Ewave\AddressVerification\Controller\Adminhtml\Index
 */
class Import extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Ewave_AddressVerification::import_file');
    }
}
