...
namespace Ewave\AddressVerification\Helper;

use Ewave\AddressVerification\Api\CountryAddressAttributeRepositoryInterface;
use Ewave\AddressVerification\Model\AllowedCountriesConfiguration;
use Ewave\AddressVerification\Model\LocationRepository;
use Magento\Framework\App\Config\ScopeConfigInterface;
use Magento\Framework\App\Helper\AbstractHelper;
use Ewave\AddressVerification\Model\ResourceModel\Location\Collection;
 ...
 * Class Aupost
 *
 * @package Ewave\AddressVerification\Helper
...
class Aupost extends AbstractHelper
{
     ...
     */
    const AUPOST_FILE_CONFIG_PATH = 'ewave_address_suggestion/general/address_data_file';
    ...
    /**
     * @var \Ewave\AddressVerification\Model\Config\Source\PostcodeRange
     */
    ...
    /**
     * @var \Ewave\AddressVerification\Api\LocationRepositoryInterface
     */
     ...
     * @param \Ewave\AddressVerification\Model\Config\Source\PostcodeRange $postcodeRangeSource
     * @param \Ewave\AddressVerification\Api\LocationRepositoryInterface $locationRepository
    ...
    public function __construct(
        ...
        \Ewave\AddressVerification\Model\Config\Source\PostcodeRange $postcodeRangeSource,
        \Ewave\AddressVerification\Api\LocationRepositoryInterface $locationRepository,
    ...
    {
        return $this->scopeConfig->getValue('ewave_address_suggestion/general/country_code', $scopeType, $scopeCode);
    }
}
