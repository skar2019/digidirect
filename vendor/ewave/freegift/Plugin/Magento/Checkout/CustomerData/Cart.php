...
namespace Ewave\FreeGift\Plugin\Magento\Checkout\CustomerData;

use Magento\Checkout\CustomerData\ItemPoolInterface;
use Magento\Checkout\Model\Session;
use Ewave\FreeGift\Helper\Data;

/**
 * Class Cart
 * @package Ewave\FreeGift\Plugin\Magento\Checkout\CustomerData
 */
class Cart
{
    /**
