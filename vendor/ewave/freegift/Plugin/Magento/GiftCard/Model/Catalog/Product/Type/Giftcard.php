...
namespace Ewave\FreeGift\Plugin\Magento\GiftCard\Model\Catalog\Product\Type;
...
use Ewave\FreeGift\Helper\InfoBuyRequestSerializer;
...
class Giftcard
{
    ...
    public function aroundPrepareForCartAdvanced(
        ...
        if ($product->getData(\Ewave\FreeGift\Model\Cart\Item::FREE_GIFT_KEY) === false
    ...
    public function aroundCheckProductBuyState(OriginalGiftcard $subject, \Closure $proceed, $product)
    {
        ...
        if ($option instanceof \Magento\Quote\Model\Quote\Item\Option) {
            ...
            if (isset($data['options'][\Ewave\FreeGift\Model\Cart\Item::FREE_GIFT_KEY])
                && $data['options'][\Ewave\FreeGift\Model\Cart\Item::FREE_GIFT_KEY] === false
            ) {
                return $subject;
            }
        }
