...
class Rates extends AbstractModifier
{
     ...
     * @var string
     */
    const URL_PATH_NEW = 'ewave_extendedshippingrates/extendedshippingrates_rate/new';
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'ewave_extendedshippingrates/extendedshippingrates_rate/edit';
     ...
     * @var string
     */
    const URL_PATH_DELETE = 'ewave_extendedshippingrates/extendedshippingrates_rate/delete';
                ...
                'data' => [
                    'config' => [
                        ...
                        'actions' => [
                            [
                                'targetName' =>
                                    'ewave_extendedshippingrates_method_form.ewave_extendedshippingrates_method_form',
                                'actionName' => 'addRate',
                                'params' => [
                                    true,
                                    [
                ...
                'arguments' => [
                    'data' => [
                        'config' => [
                            ...
                            'template' => 'Ewave_ExtendedShippingRates/components/rate/actions-list',
                            'label' => __('Actions'),
                            'fit' => true,
                        ],
                    ],
