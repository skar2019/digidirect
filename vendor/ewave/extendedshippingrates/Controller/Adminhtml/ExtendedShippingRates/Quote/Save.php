...
/**
 * Class Save
 * @package Ewave\ExtendedShippingRates\Controller\Adminhtml\ExtendedShippingRates\Quote
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class Save extends \Ewave\ExtendedShippingRates\Controller\Adminhtml\ExtendedShippingRates\Quote
{
    /**
     * @var Json
     */
    ...
    public function execute()
    {
        ...
        try {
            /** @var $model \Ewave\ExtendedShippingRates\Model\Rule */
            ...
            $this->_session->setPageData($data);
            $this->_redirect('ewave_extendedshippingrates/*/edit', ['id' => $this->getRequest()->getParam('rule_id')]);
            return;
        }
    }
     ...
     *
     * @param array $data
     * @param \Ewave\ExtendedShippingRates\Model\Rule $model
     * @return array
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     * @SuppressWarnings(PHPMD.NPathComplexity)
     * @SuppressWarnings(PHPMD.UnusedLocalVariable)
     */
    protected function prepareData($data, \Ewave\ExtendedShippingRates\Model\Rule $model)
    {
