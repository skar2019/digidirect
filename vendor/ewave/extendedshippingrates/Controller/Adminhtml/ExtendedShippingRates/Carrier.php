...
abstract class Carrier extends Action
{
    ...
    /**
     * @var \Ewave\ExtendedShippingRates\Model\CarrierRepository
     */
    ...
    protected function _initCarrier()
    {
        ...
        $this->coreRegistry->register(
            \Ewave\ExtendedShippingRates\Model\Carrier::CURRENT_CARRIER,
            $carrier
        );
        ...
        if ($id) {
            $this->coreRegistry->unregister(\Ewave\ExtendedShippingRates\Model\Carrier::CURRENT_CARRIER);
            $this->coreRegistry->register(
                \Ewave\ExtendedShippingRates\Model\Carrier::CURRENT_CARRIER,
