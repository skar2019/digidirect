...
class InstallSchema implements InstallSchemaInterface
{
    ...
    protected function addMainTable(SchemaSetupInterface $setup)
    {
        $table = $setup->getConnection()->newTable(
            ...
            $setup->getIdxName('ewave_extendedshippingrates', ['is_active', 'sort_order', 'to_date', 'from_date']),
    ...
    /**
     * Create table 'ewave_extendedshippingrates_store' if not exists. This table will be used instead of
    ...
    protected function addStoreTable(SchemaSetupInterface $setup)
    {
        ...
        $table = $setup->getConnection()->newTable(
            ...
            $setup->getIdxName('ewave_extendedshippingrates_store', ['store_id']),
            ['store_id']
        )->addForeignKey(
            $setup->getFkName(
                'ewave_extendedshippingrates_store',
                'rule_id',
            ...
            $setup->getFkName('ewave_extendedshippingrates_store', 'store_id', 'store', 'store_id'),
            'store_id',
            $storeTable,
            'store_id',
            Table::ACTION_CASCADE
        )->setComment(
            'Ewave Shipping Rules To Stores Relations'
        );
    ...
    /**
     * Create table 'ewave_extendedshippingrates_customer_group' if not exists. This table will be used instead of
    ...
    protected function addCustomerGroupTable(SchemaSetupInterface $setup)
    {
        ...
        $table = $setup->getConnection()->newTable(
            ...
            $setup->getIdxName('ewave_extendedshippingrates_customer_group', ['customer_group_id']),
            ['customer_group_id']
        )->addForeignKey(
            $setup->getFkName(
                'ewave_extendedshippingrates_customer_group',
                'rule_id',
                'ewave_extendedshippingrates',
                'rule_id'
            ),
            ...
            'Ewave Shipping Rules To Customer Groups Relations'
        );
    ...
    {
        /**
         * Create table 'ewave_extendedshippingrates_carrier_label'
         */
        $table = $setup->getConnection()->newTable(
            ...
            'Ewave Shipping Rules Carrier Label'
        );
        $setup->getConnection()->createTable($table);

        /**
         * Create table 'ewave_extendedshippingrates_methods_label'
         */
        $table = $setup->getConnection()->newTable(
            ...
            'Ewave Shipping Rules Method Label'
        );
        $setup->getConnection()->createTable($table);
    }
    ...
    protected function addZonesStoreViewTable($setup)
    {
        ...
        /**
         * Create table 'ewave_extendedshippingrates_zone_store' if not exists. This table will be used instead of
        ...
        $table = $setup->getConnection()->newTable(
            ...
            'Ewave Shipping Zones To Stores Relations'
        );
