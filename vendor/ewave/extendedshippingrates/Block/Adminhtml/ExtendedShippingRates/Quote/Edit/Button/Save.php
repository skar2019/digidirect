...
use Ewave\ExtendedShippingRates\Ui\DataProvider\Quote\Form\Modifier\AbstractModifier as Modifier;
...
{
    const TARGET_FORM_NAME = 'ewave_extendedshippingrates_quote_form.ewave_extendedshippingrates_quote_form';
