<?php
namespace Ewave\ExtendedShippingRates\Block\Adminhtml\ExtendedShippingRates\Widget;
...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl(
            'ewave_extendedshippingrates/extendedshippingrates_quote/chooser',
            ['uniq_id' => $uniqId]
        );
    ...
    {
        return $this->getUrl('ewave_extendedshippingrates/extendedshippingrates_quote/chooser', ['_current' => true]);
    }
}
