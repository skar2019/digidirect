<?php
namespace Ewave\ExtendedShippingRates\Model\Carrier\Method;
...
/**
 * Class Rate
 * @package Ewave\ExtendedShippingRates\Model\Carrier\Method
 */
class Rate extends AbstractExtensibleModel implements RateInterface
{
    ...
    {
        parent::_construct();
        $this->_init('Ewave\ExtendedShippingRates\Model\ResourceModel\Rate');
     ...
     * @return float
     */
    public function validatePackagingWeight($weight, \Ewave\ExtendedShippingRates\Model\Carrier\Method $methodData)
    {
