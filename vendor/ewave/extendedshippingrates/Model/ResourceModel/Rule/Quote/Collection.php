<?php
namespace Ewave\ExtendedShippingRates\Model\ResourceModel\Rule\Quote;

class Collection extends \Ewave\ExtendedShippingRates\Model\ResourceModel\Rule\Collection
{
    /**
     * Add stores for load
     *
