...
class Method extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    /**
     * @var \Ewave\ExtendedShippingRates\Model\ResourceModel\Rate\CollectionFactory
     */
    protected $rateCollectionFactory;

    /**
     * @var \Ewave\ExtendedShippingRates\Model\Rate\Import
     */
    protected $import;
     ...
     * @param \Ewave\ExtendedShippingRates\Model\ResourceModel\Rate\CollectionFactory $rateCollectionFactory
     * @param \Ewave\ExtendedShippingRates\Model\Rate\Import $import
    ...
    public function __construct(
        ...
        \Ewave\ExtendedShippingRates\Model\ResourceModel\Rate\CollectionFactory $rateCollectionFactory,
        \Ewave\ExtendedShippingRates\Model\Rate\Import $import,
    ...
    {
        $deleteByStoreIds = [];
        $table = $this->getTable(\Ewave\ExtendedShippingRates\Model\Carrier::METHOD_LABELS_TABLE_NAME);
    ...
    public function getStoreLabels($methodId)
    {
        $select = $this->getConnection()->select()->from(
            $this->getTable(\Ewave\ExtendedShippingRates\Model\Carrier::METHOD_LABELS_TABLE_NAME),
            ['store_id', 'label']
        )->where(
            'method_id = :method_id'
        );
    ...
    {
        /** @var \Ewave\ExtendedShippingRates\Model\ResourceModel\Rate\Collection $rates */
     ...
     * @return \Ewave\ExtendedShippingRates\Model\Rate\Import
     */
