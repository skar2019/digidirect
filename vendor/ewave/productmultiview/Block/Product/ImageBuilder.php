<?php
namespace Ewave\ProductMultiView\Block\Product;

use Magento\Catalog\Block\Product\ImageFactory;
use Magento\Catalog\Helper\ImageFactory as HelperFactory;
use Ewave\ProductMultiView\Helper\Data as MultiViewHelper;
...
class ImageBuilder extends \Magento\Catalog\Block\Product\ImageBuilder
{
    ...
    public function create(Product $product = null, string $imageId = null, array $attributes = null)
    {
        ...
        $template = $helper->getFrame()
            ? 'Ewave_ProductMultiView::product/image.phtml'
            : 'Ewave_ProductMultiView::product/image_with_borders.phtml';
