<?php
namespace Ewave\ProductMultiView\Test\Unit\Helper;
...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Data helper
     * @var \Ewave\ProductMultiView\Helper\Data
     */
    ...
    /**
     * Image Builder
     * @var \Ewave\ProductMultiView\Block\Product\ImageBuilder
     */
    ...
    public function setUp()
    {
        ...
        $this->_imageBuilder = $this->getMockBuilder('Ewave\ProductMultiView\Block\Product\ImageBuilder')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->_dataHelper = $this->_objectManager->getObject('Ewave\ProductMultiView\Helper\Data', [
            '_imageBuilder' => $this->_imageBuilder,
        ]);

        $requestProperty = new \ReflectionProperty('Ewave\ProductMultiView\Helper\Data', 'scopeConfig');
    ...
    public function testModuleDisabled()
    {
        $this->_scopeConfig->expects($this->any())
            ->method('isSetFlag')
            ->with(\Ewave\ProductMultiView\Helper\Data::CONFIG_ENABLED, 'website')
            ->willReturn(false);
    ...
    public function testProductHasAlternativeImage()
    {
        ...
        $this->_product->expects($this->any())
            ->method('getData')
            ->with(\Ewave\ProductMultiView\Helper\Data::ALTERNATIVE_IMAGE_KEY)
    ...
    public function testDisplayRandomHoverDisabled()
    {
        ...
        $this->_scopeConfig->expects($this->at(1))
            ->method('isSetFlag')
            ->with(\Ewave\ProductMultiView\Helper\Data::CONFIG_DISPLAY_RANDOM_HOVER, 'website')
            ->willReturn(false);
