...
namespace Ewave\AI\Model\ResourceModel\Integrations;

/**
 * Class Integrations
 * @package Ewave\AI\Model\ResourceModel\Integrations
 */
class Integrations extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('ewave_ai_integrations', 'id');
    }
    ...
    public function completeData($integration, $processCode = null)
    {
        ...
        if ($isObjectNew) {
            $integration->setData('status', \Ewave\AI\Model\Integrations\Integrations::STATUS_PENDING);
