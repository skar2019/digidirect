...
use Ewave\AI\Helper\Engine as EngineHelper;
...
use Ewave\AI\Model\Engine\Queue\QueueFactory;
...
class QueueProcessor
{
    const CONFIG_NUMBER_OF_ATTEMPTS = 'ewave_ai/queue/number_of_attempts';
    const CONFIG_NUMBER_OF_ATTEMPTS_PER_PROCESS = 'ewave_ai/queue/number_of_attempts_per_process';
     ...
     * @param \Ewave\AI\Model\Engine\Queue\QueueRepository $queueRepository
     * @param \Ewave\AI\Model\Engine\Queue\QueueFactory $queueFactory
    ...
    public function processQueueItem(QueueInterface $queueItem)
    {
        ...
        try {
            /** @var \Ewave\AI\Model\Engine\Engine $integration */
