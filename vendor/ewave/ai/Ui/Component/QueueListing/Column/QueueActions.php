<?php
namespace Ewave\AI\Ui\Component\QueueListing\Column;
 ...
 * Class QueueActions
 *
 * @package Ewave\AI\Ui\Component\LogsListing\Column
 */
class QueueActions extends Column
{
     ...
     * Url path delete
     */
    const URL_PATH_DELETE = 'ewave_ai/queue/delete';

    /**
     * Url path run
     */
    const URL_PATH_RUN = 'ewave_ai/queue/run';

    /**
     * Preview url
     */
    const URL_PATH_DETAILS = 'ewave_ai/queue/details';
