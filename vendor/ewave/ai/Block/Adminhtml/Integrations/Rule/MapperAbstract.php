<?php
namespace Ewave\AI\Block\Adminhtml\Integrations\Rule;

use Ewave\AI\Model\Integrations\Rule\Mapping\MapperInterface;
use Ewave\AI\Api\MapperDataRepositoryInterface;
...
abstract class MapperAbstract extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Ewave_AI::integrations/rule/mapper.phtml';
