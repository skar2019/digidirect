...
namespace Ewave\AI\Test\Unit\Model\Lib\Import\Product;
...
class EntityTest extends AbstractImportTestCase
{
    ...
    /**
     * @var \Ewave\AI\Model\Lib\Import\Product\Service\DataSource
     */
    ...
    protected function setUp()
    {
        ...
        $this->storeResolver =
            $this->getMockBuilder('\Magento\CatalogImportExport\Model\Import\Product\StoreResolver')
                ...
                ->getMock();
        $this->skuProcessor =
            $this->getMockBuilder('\Ewave\AI\Model\Lib\Import\Product\Entity\SkuProcessor')
                ->disableOriginalConstructor()
                ->getMock();
        ...
        $this->_dataSource = $this->getMockBuilder('\Ewave\AI\Model\Lib\Import\Product\Service\DataSource')
            ->setMethods(null)
            ->getMock();
        ...
        $this->importProduct = new Entity(
            ...
            $this->_dataSource,
            $this->prodAttrColFac,
            $this->getMockBuilder('Ewave\AI\Model\Logger\Logger')->disableOriginalConstructor()->getMock(),
            $this->data
        );
    }
