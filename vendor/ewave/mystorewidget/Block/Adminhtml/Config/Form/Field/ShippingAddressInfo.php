<?php
namespace Ewave\MyStoreWidget\Block\Adminhtml\Config\Form\Field;
    ...
    protected function _getAddressAttributeRenderer()
    {
        if (!$this->_entityRenderer) {
            $this->_entityRenderer = $this->getLayout()->createBlock(
                'Ewave\MyStoreWidget\Block\Adminhtml\Config\Form\Field\AddressAttributeRenderer',
                '',
    ...
    protected function _getAttributeRenderer()
    {
        if (!$this->_attributeRenderer) {
            $this->_attributeRenderer = $this->getLayout()->createBlock(
                'Ewave\MyStoreWidget\Block\Adminhtml\Config\Form\Field\AttributeRenderer',
                '',
                ['data' => ['is_render_to_js_template' => true]]
            );
