<?php
namespace Ewave\MyStoreWidget\Block;
...
/**
 * Class MyStore
 * @package Ewave\MyStoreWidget\Block
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class MyStore extends \Magento\Framework\View\Element\Template implements IdentityInterface
{
    const SAVE_URL_PATH = 'ewave_mystorewidget/mystorewidget/save';
    const REMOVE_URL_PATH = 'ewave_mystorewidget/mystorewidget/delete';
    const SEARCH_URL_PATH = 'ewave_mystorewidget/mystorewidget/search';
    ...
    /**
     * @var \Ewave\MyStoreWidget\Helper\Config
     */
    ...
    /**
     * @var \Ewave\MyStoreWidget\Model\Config\Source\Stores
     */
     ...
     * @param \Ewave\MyStoreWidget\Model\Config\Source\Stores $storesSourceModel
     * @param \Ewave\MyStoreWidget\Model\MyStoreRepository $myStoreRepository
     * @param CustomerSessionFactory $customerSessionFactory
     * @param Helper $helper
     * @param \Ewave\MyStoreWidget\Helper\Config $helperConfig
    ...
    public function __construct(
        ...
        \Ewave\MyStoreWidget\Model\Config\Source\Stores $storesSourceModel,
        \Ewave\MyStoreWidget\Model\MyStoreRepository $myStoreRepository,
        CustomerSessionFactory $customerSessionFactory,
        Helper $helper,
        \Ewave\MyStoreWidget\Helper\Config $helperConfig,
