<?php
namespace Ewave\BlogInfiniteScroll\Model\Blog;

use Ewave\InfiniteScroll\Model\ProcessorInterface as InfiniteScrollProcessorInterface;
use Ewave\BlogInfiniteScroll\Helper\Config;
 ...
 * Class Processor
 *
 * @package Ewave\BlogInfiniteScroll\Model\Blog
 */
class Processor implements InfiniteScrollProcessorInterface
{
    ...
    public function getCurrentSize()
    {
        ...
        /* @var $block \Ewave\Blog\Block\Blog */
    ...
    /**
     * @return bool|\Ewave\Blog\Block\Blog
     * @throws \Exception
     */
