...
namespace Ewave\Vii\Service\Command;

use Ewave\AbstractGiftCard\Api\AbstractGiftCardLoggerInterface as LoggerInterface;
 ...
 * @package Ewave\Vii\Service\Command
 */
class ServiceCommand extends \Ewave\AbstractGiftCard\Service\Command\ServiceCommand
{
    /**
     * @var Config
     */
    ...
    /**
     * @param \Ewave\AbstractGiftCard\Service\Http\TransferInterface $transferO
     * @param array $commandSubject
     * @param \Exception $e
     * @return array|\Ewave\AbstractGiftCard\Service\Command\ServiceCommand|null
    ...
    protected function doOnCatch($transferO, $commandSubject, \Exception $e)
    {
        ...
        /** @var \Ewave\AbstractGiftCard\Model\Service\Adapter $service */
     ...
     * @param \Ewave\AbstractGiftCard\Model\Service\Adapter $service
     * @return $this
     * @throws LocalizedException
     */
    ...
    /**
     * @param \Ewave\AbstractGiftCard\Service\Validator\ResultInterface $result
     * @param \Ewave\AbstractGiftCard\Service\Http\TransferInterface $transferO
     * @param array $commandSubject
     * @return void
