 ...
 */
class CleanupProcess extends \Ewave\Vii\Model\Processor\ProcessAbstract implements ProcessorInterface
{
    const PROCESS_CODE = 'ewave_vii_abandoned_cart_cleanup';
