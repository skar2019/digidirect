...
namespace Ewave\MagentoFixes\Controller\Adminhtml\Paypal\Express;
...
/**
 * Class Authorization
 * @package Ewave\MagentoFixes\Controller\Adminhtml\Paypal\Express
 */
class Authorization extends Order
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Ewave_MagentoFixes::paypal_authorization';
