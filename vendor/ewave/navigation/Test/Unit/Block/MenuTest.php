<?php
namespace Ewave\Navigation\Test\Unit\Block;
...
/**
 * Class MenuTest
 * @package Ewave\Navigation\Test\Unit\Block
 */
class MenuTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Ewave\Navigation\Block\Menu
     */
    ...
    public function setUp()
    {
        ...
        $this->_menuCollectionFactory = $this->getMockObjectWithoutConstructor(
            'Ewave\Navigation\Model\ResourceModel\Menu\CollectionFactory',
            ['create']
        );

        $this->menuRepositoryMock = $this->getMockObjectWithoutConstructor(
            'Ewave\Navigation\Model\ResourceModel\MenuRepository',
            ['getListBySetId']
        );
    ...
    protected function _getMenuItemMock(
        ...
        $menuRef = $this->_createReflectionClass('Ewave\Navigation\Model\Menu');
