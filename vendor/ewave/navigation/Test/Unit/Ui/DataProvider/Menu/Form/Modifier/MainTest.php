...
class Main extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_menuModifier = $this->_objectManager->getObject(
            'Ewave\Navigation\Ui\DataProvider\Menu\Form\Modifier\Main',
            [
    ...
    public function testModifyData()
    {
        ...
        $this->_registryMock->expects($this->at(0))
            ->method('registry')
            ->with(\Ewave\Navigation\Model\Registry\Constants::CURRENT_MENU_ITEM)
    ...
    {
        $reflectionClass = $this->_createReflectionClass('Ewave\Navigation\Ui\DataProvider\Menu\Form\Modifier\Main');
