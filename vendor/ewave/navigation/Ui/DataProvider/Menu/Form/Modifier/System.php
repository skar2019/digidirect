...
class System extends MenuModifier
{
    ...
    public function modifyData(array $data)
    {
        ...
        $submitUrl = $this->urlBuilder->getUrl('ewave_navigation/menu/save', $actionParameters);
        $validateUrl = $this->urlBuilder->getUrl('ewave_navigation/menu/validate', $actionParameters);
