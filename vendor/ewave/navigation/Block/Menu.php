...
namespace Ewave\Navigation\Block;

use Ewave\Navigation\Api\MenuRepositoryInterface;
use Ewave\Navigation\Component\Json;
use Ewave\Navigation\Model\Frontend\CacheKeyGeneratorInterface;
use Ewave\Navigation\Model\Frontend\StoreResolver;
use Ewave\Navigation\Model\MenuCache;
 ...
 *
 * TODO: refactor to use \Ewave\Navigation\Model\Frontend\MenuSetData as it's done in widget
 */
class Menu extends Template implements DataObject\IdentityInterface, MenuBlockInterface
{
    ...
    protected function _makeOutputArray($collection)
    {
        ...
        $this->_eventManager->dispatch(
            'ewave_navigation_prepare_menu_after',
            [
