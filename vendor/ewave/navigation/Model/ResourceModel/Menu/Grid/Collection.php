<?php
namespace Ewave\Navigation\Model\ResourceModel\Menu\Grid;
...
use Ewave\Navigation\Setup\InstallSchema;
use Magento\Store\Model\Store;
use Ewave\Navigation\Model\ResourceModel\Menu\JoinTypeInterface;

/**
 * Class Collection
 *
 * @package Ewave\Navigation\Model\ResourceModel\Menu\Grid
 */
class Collection extends \Ewave\Navigation\Model\ResourceModel\Menu\Collection
{
    /**
     * @var array
     */
    ...
    protected function _afterLoad()
    {
        ...
        if (!empty($allIds)) {
            ...
            $select = $connection->select()
                ->from($this->getTable('ewave_navigation_menu_item_store_relation'),
            ...
            ->joinLeft(
                [
                    $tableAlias => $this->getTable(
                        InstallSchema::EWAVE_NAVIGATION_MENU_SET_LINK
                    )
                ],
