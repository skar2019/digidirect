...
namespace Ewave\Navigation\Controller\Adminhtml;
...
abstract class AbstractMassAction extends Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Ewave_Navigation::navigation';
    ...
    {
        return $this->filter->getComponentRefererUrl() ?: 'ewave_navigation/*/index';
    }
