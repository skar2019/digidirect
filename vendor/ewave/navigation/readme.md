...
For example if we created menu set maned header:
            ...
            <block class="Ewave\Navigation\Block\Menu" name="ewave.menu.header" as="ewave_menu_header" template="menu_static.phtml">
                <arguments>
                    ...
                    <argument name="view_custom" xsi:type="string">Ewave_Navigation/js/dist/views/custom/index</argument>
...
### VERSION 1.0.3 
  ...
  Database structure changes:
      1. Added "ewave_navigation_menu_item_store_relation" table. Now user can assign menu item to specified store
