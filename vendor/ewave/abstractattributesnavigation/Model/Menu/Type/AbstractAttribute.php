<?php
namespace Ewave\AbstractAttributesNavigation\Model\Menu\Type;

use Ewave\AbstractAttributes\Api\Data\AbstractAttributeInterface;
use Ewave\Navigation\Model\Menu\Type\AbstractType;
use Ewave\Navigation\Model\Menu\Type\MenuDataInterface;
use Ewave\Navigation\Helper\Data as MenuHelper;
...
use Ewave\AbstractAttributes\Helper\Attribute as AbstractAttributeHelper;

/**
 * Class AbstractAttribute
 *
 * @package Ewave\AbstractAttributesNavigation\Model\Menu
 */
class AbstractAttribute extends AbstractType implements MenuDataInterface
{
    const PREFIX = 'attribute';
    const ABSTRACT_ATTRIBUTES_REGISTRY_KEY = 'ewave_abstract_attributes';
    const ABSTRACT_ATTRIBUTES_OPTIONS_REGISTRY_KEY = 'ewave_abstract_attributes_options';
    ...
    /**
     * @param \Ewave\AbstractAttributes\Model\Option $option
     * @return array
     */
    ...
    protected function isActiveUrl($option)
    {
        ...
        if (!($optionRegistry instanceof \Ewave\AbstractAttributes\Model\Option)) {
            return false;
        }
     ...
     * @param int $optionId
     * @param int $attributeId
     * @return \Ewave\AbstractAttributes\Api\Data\OptionInterface|null
     */
