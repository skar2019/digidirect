<?php
namespace Ewave\AbstractAttributesNavigation\Ui\DataProvider\Menu\Form\Modifier;
...
use Ewave\Navigation\Ui\DataProvider\Menu\Form\Modifier\MenuModifier;
use Magento\Framework\Registry;
use Ewave\AbstractAttributes\Model\ResourceModel\Option\Grid\CollectionFactory as OptionsCollectionFactory;

/**
 * Class AbstractAttribute
 * @package Ewave\AbstractAttributesNavigation\Ui\DataProvider\Menu\Form\Modifier
 */
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'formElement' => 'select',
                        'componentType' => 'field',
                        'component' => 'Ewave_AbstractAttributesNavigation/js/component/abstract-attributes-multiselect-dropdown',
                        'filterOptions' => true,
                        'chipsEnabled' => true,
                        'disableLabel' => true,
                        'levelsVisibility' => '1',
