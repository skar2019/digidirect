<?php
namespace Ewave\AdvancedInventory\Model\ResourceModel\AdvancedInventory\Grid;
...
class Collection extends \Ewave\AdvancedInventory\Model\ResourceModel\AdvancedInventory\Collection
    implements SearchResultInterface
{
    ...
    {
        $this->addAttributeToSelect($this->gridColumns, true);
