<?php
namespace Ewave\AbstractAttributes\Model\ResourceModel;
...
/**
 * Class Option
 * @package Ewave\AbstractAttributes\Model\ResourceModel
 */
class Option extends AbstractDb
{
    ...
    public function isOptionAvailable($attributeId)
    {
        $conn = $this->getConnection();
        $select = $conn->select()
            ->from($this->getTable('ewave_aa'), [OptionInterface::ATTRIBUTE_ID])
    ...
    {
        $this->_init('ewave_aa_options', OptionInterface::ID);
