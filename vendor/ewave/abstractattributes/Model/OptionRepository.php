...
use Ewave\AbstractAttributes\Api\Data\OptionSearchResultsInterfaceFactory;
use Ewave\AbstractAttributes\Helper\Image as ImageHelper;
use Ewave\AbstractAttributes\Helper\ImageFactory as ImageHelperFactory;
use Ewave\AbstractAttributes\Model\Media\ImageProcessorFactory;
 ...
 */
class OptionRepository implements \Ewave\AbstractAttributes\Api\OptionRepositoryInterface
{
    use AbstractRepositoryTrait;

    /**
     * @var \Ewave\AbstractAttributes\Api\Data\AbstractAttributeInterface[]
     */
    ...
    public function get($id, $forceReload = false)
    {
        if (!isset($this->instances[$id]) || $forceReload) {
            /** @var \Ewave\AbstractAttributes\Api\Data\OptionInterface $option */
    ...
    public function save(\Ewave\AbstractAttributes\Api\Data\OptionInterface $option)
    {
        ...
        try {
            ...
            if ($optionId) {
                ...
                /** @see \Ewave\AbstractAttributes\Model\ResourceModel\Entity\Attribute::_updateAttributeOption */
            ...
            /** @see \Ewave\AbstractAttributes\Model\ResourceModel\AbstractAttribute::_afterSave */
