Ewave Abstract Attributes
=====================

[wiki link](https://wiki.ewave.com/display/LEGO/Abstract+Attributes)
...
##### InfiniteScroll:
- Please install "ewave/abstractattributesinfinitescroll" addon.

##### LayeredNavigation:
- Please install "ewave/abstractattributeslayerednavigation" addon.

### VERSION 1.4.0

1. Added created and modified columns in ewave_aa_options table
