...
use Ewave\AbstractAttributes\Model\UrlProcessor\Option as OptionUrlProcessor;
use Ewave\AbstractAttributes\Model\UrlProcessor\Attribute as AttributeUrlProcessor;
...
{
    const URL_SUFFIX_CONFIG = 'ewave_aa_config/general/url_suffix';
