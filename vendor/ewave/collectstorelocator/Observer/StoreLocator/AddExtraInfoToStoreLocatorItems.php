<?php
namespace Ewave\CollectStoreLocator\Observer\StoreLocator;

use Magento\Framework\Event\Observer;
use Magento\Framework\Event\ObserverInterface;
use Magento\Checkout\Model\Session;
use Ewave\CollectAbstractEntity\Helper\Places;
use Ewave\Collect\Helper\Data;
use Ewave\Collect\Api\CollectPlaceRepositoryInterface;

/**
 * Class AddExtraInfoToStoreLocatorItems
 * @package Ewave\CollectStoreLocator\Observer\StoreLocator
 */
    ...
    public function addAvailabilityInfoToItems($items)
    {
        ...
        foreach ($items as $key => $storeData) {
            ...
            if ($place->hasData(CollectPlaceRepositoryInterface::KEY_IS_UNAVAILABLE)) {
                $items[$key]['available'] = !$place->getData(CollectPlaceRepositoryInterface::KEY_IS_UNAVAILABLE);
            }
        }
        return $items;
    }
