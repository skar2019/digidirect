define([
    ...
    return Component.extend({
        defaults: {
            ...
            targetFields: ['product_form.product_form.advanced_inventory_modal.stock_data.container_ewave_product_availability_date'],
            conditions: [
                {
                    'product[stock_data][backorders]': ['111']
                }     
            ],
            dateField: 'product_form.product_form.advanced_inventory_modal.stock_data.container_ewave_product_availability_date.ewave_product_availability_date'
        },
        initialize: function () {
            this._super();
            this.bindOpenModal();
