 ...
 */
class OrderItemPreorderRepository implements \Ewave\PreOrder\Api\OrderItemPreorderRepositoryInterface
{
    /**
    ...
    /**
     * @var \Ewave\PreOrder\Api\Data\OrderItemPreorderInterface[]
     */
    protected $registry;
     ...
     * {@inheritdoc}
     */
    public function save(\Ewave\PreOrder\Api\Data\OrderItemPreorderInterface $orderItemItemPreorder)
    {
        try {
     ...
     * {@inheritdoc}
     */
    public function delete(\Ewave\PreOrder\Api\Data\OrderItemPreorderInterface $orderItemPreorder)
    {
        try {
