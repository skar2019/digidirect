...
{
    const URL_PATH_DETAILS = 'ewave_abstractentity/abstractentity/details';
    const URL_PATH_EDIT = 'ewave_abstractentity/abstractentity/edit';
    const URL_PATH_DELETE = 'ewave_abstractentity/abstractentity/delete';
