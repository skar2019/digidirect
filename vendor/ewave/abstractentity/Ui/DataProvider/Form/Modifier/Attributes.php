...
use Ewave\AbstractEntity\Model\ResourceModel\Eav\Attribute as EavAttribute;
...
class Attributes extends AbstractModifier
{
     ...
     *
     * @param \Ewave\AbstractEntity\Model\ResourceModel\Eav\Attribute $attribute
     * @param array $meta
     * @return array
     */
    ...
    protected function _isDisabled(EavAttribute $attribute)
    {
        ...
        return !$this->scopeOverriddenValue->containsValue(
            \Ewave\AbstractEntity\Api\Data\AbstractEntityInterface::class,
            $currentEntity,
