<?php
namespace Ewave\AbstractEntity\Controller\Set;
...
/**
 * Class View
 * @package Ewave\AbstractEntity\Controller\Set
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class View extends Action
{
    const ADDITIONAL_SET_HANDLE = 'ewave_abstractentity_view_set_';
    const ADDITIONAL_HANDLE = 'ewave_attributeset_view_';
