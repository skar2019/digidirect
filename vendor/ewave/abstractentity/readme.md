Ewave Abstract Entity
=====================

[wiki link](https://wiki.ewave.com/display/LEGO/Abstract+Entity)
...
<frontend_class>ewave_abstract_entities</frontend_class>
<frontend_class>ewave_abstract_entities_attributes</frontend_class>
...
<field id="abstract_entity" translate="label" type="select" sortOrder="10" showInDefault="1" showInWebsite="0" showInStore="0">
    ...
    <source_model>Ewave\AbstractEntity\Model\Config\Source\AttributeSet</source_model>
    <frontend_class>ewave_abstract_entities</frontend_class>
</field>
...
Templates for class:
ewave_abstract_entities_attribute_[backend_type]  - will return all attributes with this backend_type
ewave_abstract_entities_attribute_[backend_type]_[frontend_input] - - will return all attributes with this backend_type and frontend input

Class examples:
ewave_abstract_entities_attribute_int
ewave_abstract_entities_attribute_int_select
ewave_abstract_entities_attribute_int_text
ewave_abstract_entities_attribute_varchar_text
ewave_abstract_entities_attribute_varchar
ewave_abstract_entities_attribute_varchar_image
ewave_abstract_entities_attribute_text
etc.
...
1. Reindex process significantly changed.
   ...
   ewave_abstractentity_index_bicycle_1
   ewave_abstractentity_index_bicycle_2
   ewave_abstractentity_index_bicycle_3
