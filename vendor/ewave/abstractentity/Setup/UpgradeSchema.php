...
use Ewave\AbstractEntity\Model\ResourceModel\AdditionalAttributes;
...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    {
        return $this->_setup->getTable('ewave_abstractentity_entity');
    }
    ...
    {
        return $this->_setup->getTable('ewave_abstractentity_entity_relation');
    }
    ...
    {
        return $this->_setup->getTable('ewave_abstractentity_entity_additional_attributes');
    }
    ...
    protected function _addParentEntityFieldRequired()
    {
        ...
        $parentIdFieldRequired = \Ewave\AbstractEntity\Model\ResourceModel\Relation::IS_PARENT_REQUIRED;
    ...
    /**
     * Create 'ewave_abstractentity_entity_relation' table
     * @return void
    ...
    protected function _createRelationTable()
    {
        ...
        /**
         * Create table 'ewave_abstractentity_entity_relation'
         */
        $table = $this->_setup->getConnection()
            ...
            ->addIndex(
                $this->_setup->getIdxName('ewave_abstractentity_entity_link', ['parent_attribute_set_id']),
                ['parent_attribute_set_id']
            )
            ->addForeignKey(
                $this->_setup->getFkName(
                    'ewave_abstractentity_entity_link',
                    'parent_attribute_set_id',
                    'eav_attribute_set',
                    'attribute_set_id'
                ),
    ...
    protected function _createAdditionalAttributesTable()
    {
        ...
        /**
         * Create table 'ewave_abstractentity_entity_additional_attributes'
         */
        $table = $this->_setup->getConnection()
            ...
            ->addIndex(
                $this->_setup->getIdxName('ewave_abstractentity_entity_link', ['attribute_set_id']),
                ['attribute_set_id']
            )
            ->addForeignKey(
                $this->_setup->getFkName(
                    'ewave_abstractentity_entity_additional_attributes',
                    'attribute_set_id',
                    'eav_attribute_set',
                    'attribute_set_id'
                ),
