...
class Observer extends MagentoObserver
{
     ...
     *
     * @param \Ewave\OutOfStockNotif\Model\Email $email
     * @return $this
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     * @SuppressWarnings(PHPMD.NPathComplexity)
     */
    protected function _processGuestStock(\Ewave\OutOfStockNotif\Model\Email $email)
    {
        $email->setType('stock');
    ...
    {
        /* @var $email \Ewave\OutOfStockNotif\Model\Email */
