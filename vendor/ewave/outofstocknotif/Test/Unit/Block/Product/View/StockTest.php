<?php
namespace Ewave\OutOfStockNotif\Test\Unit\Block\Product\View;

/**
 * Test class for \Ewave\OutOfStockNotif\Block\Product\View\Stock
 */
class StockTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|\Ewave\OutOfStockNotif\Helper\Data
     */
    protected $_ewaveHelper;
    ...
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|\Ewave\OutOfStockNotif\Block\Product\View\Stock
     */
    protected $_block;
    ...
    protected function setUp()
    {
        ...
        $this->_ewaveHelper = $this->getMock(
            'Ewave\OutOfStockNotif\Helper\Data',
            ['isEnabledForGuest'],
            [],
            '',
            false
        ...
        $this->_block = $objectManager->getObject(
            'Ewave\OutOfStockNotif\Block\Product\View\Stock',
            ['helper' => $this->_helper, 'ewaveHelper' => $this->_ewaveHelper, 'registry' => $this->_registry]
        );
    ...
    public function testEnabledForGuests()
    {
        ...
        $this->_ewaveHelper->expects($this->any())->method('isEnabledForGuest')->will($this->returnValue(true));
