...
use Ewave\CheckoutFields\Model\ResourceModel\PdpFieldValue;
...
/**
 * Class UpgradeSchema
 * @package Ewave\CheckoutFields\Setup
 */
class UpgradeSchema implements UpgradeSchemaInterface
{
    const ORDER_TABLE = 'ewave_checkout_fields_order_field_value';
    const QUOTE_TABLE = 'ewave_checkout_fields_quote_field_value';
    ...
    public function addTableForPDPFiledValue()
    {
        ...
        if (!$this->isTableExists($tableName)) {
            $table = $this->connection->newTable(
                ...
                ->setComment('Ewave CheckoutFields Table for Values from PDP');
