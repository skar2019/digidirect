 ...
 * @package Ewave\CheckoutFields\Plugin\Checkout\Model
 */
class LayoutProcessor
{
    /**
    ...
    public function afterProcess(MagentoLayoutProcessor $subject, array $jsLayout)
    {
        ...
        foreach ($fields as $code => $options) {
            ...
            try {
                /** @var \Ewave\CheckoutFields\Model\Component\Type\AbstractType $model */
                $model = $this->typeFactory->create('\Ewave\CheckoutFields\Model\Component\Type\\' . $type);
