...
namespace Ewave\Faq\Model\Email;
 ...
 * Class Admin
 *
 * @package Ewave\Faq\Model\Email
 */
class Admin
{
    const XML_PATH_EMAIL_TEMPLATE = 'ewave_faq/notification/template';
    const XML_PATH_EMAIL_SENDER = 'ewave_faq/notification/sender';
    const XML_PATH_EMAIL_RECIPIENT = 'ewave_faq/notification/receiver';
