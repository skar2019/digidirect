 ...
 */
class CategoryRepository implements \Ewave\Faq\Api\CategoryRepositoryInterface
{
    /**
     * @var \Ewave\Faq\Model\CategoryFactory
     */
     ...
     *
     * @param \Ewave\Faq\Model\CategoryFactory $categoryFactory
    ...
    public function __construct(
        \Ewave\Faq\Model\CategoryFactory $categoryFactory,
        \Ewave\Faq\Model\ResourceModel\Category $categoryResource,
     ...
     * {@inheritdoc}
     */
    public function save(\Ewave\Faq\Model\Category $category)
    {
        if (!$category->getId()) {
    ...
    public function deleteById($id)
    {
        ...
        foreach ($stores as $store) {
            $questionCategoryStore = $this->scopeConfig->getValue(
                'ewave_faq/customer_questions/category_id',
            ...
            if ($id == $questionCategoryStore) {
                $message = __(
                    ...
                    If you want to delete it anyway, please change the setting Stores - Configuration - Ewave - FAQ'
                );
