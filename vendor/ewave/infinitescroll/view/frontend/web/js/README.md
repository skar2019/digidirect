...
buttonTemplate | string |  'text!Ewave_InfiniteScroll/template/button.html' | Affected inside 'viewCustom'
...
viewCustom | string |  '' | Extends core View. Example: 'Ewave_InfiniteScroll/js/dist/views/catalog-search/index'
