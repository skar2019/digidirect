define(['module', 'exports', 'jquery', './../index', 'text!Ewave_InfiniteScroll/template/catalog-listing/button.html', './../actions/update-amount', 'Magento_Customer/js/customer-data'], function (module, exports, _jquery, _index, _button, _updateAmount, _customerData) {
    'use strict';
    ...
    var ViewCustom = function (_View) {
        ...
        _createClass(ViewCustom, [{
            ...
            value: function _setButtonContent(currentCount, totalCount) {
                return 'Load more | Showing ' + currentCount + ' / ' + totalCount + ' product(s)';
            }
        }, {
