<?php
namespace Ewave\ProductOverlay\Cron;

use Ewave\ProductOverlay\Helper\Data as Helper;
...
class CacheCleaner
{
    const FLAG_KEY = 'ewave_productoverlay_cache_data';
    ...
    protected function cleanOverlaysCache()
    {
        ...
        foreach ($products->getItems() as $product) {
            ...
            foreach ($productOverlays as $productOverlay) {
                /* @var $productOverlay \Ewave\ProductOverlay\Model\Overlays */
