...
namespace Ewave\ProductOverlay\Block\Adminhtml;

/**
 * Class Overlays
 * @package Ewave\ProductOverlay\Block\Adminhtml
 */
class Overlays extends \Magento\Backend\Block\Widget\Grid\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Ewave_ProductOverlay';
        $this->_headerText = __('Product Overlays');
        parent::_construct();

        if ($this->_isAllowedAction('Ewave_ProductOverlay::save')) {
