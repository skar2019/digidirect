...
use Ewave\ProductOverlay\Model\Rule\ProcessorInterface;
...
class AbstractOverlays extends AbstractModel implements OverlayInterface, IdentityInterface
{
     ...
     * @var string
     */
    protected $_cacheTag = 'ewave_productoverlay';
     ...
     * @var string
     */
    protected $_eventPrefix = 'ewave_productoverlay';

    /**
     * Product overlay cache tag
     */
    const CACHE_TAG = 'ewave_productoverlay';
