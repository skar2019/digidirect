<?php
namespace Ewave\AbstractAttributesNavigation\Model\ResourceModel;

use Ewave\Navigation\Model\ResourceModel\Type\SaveProcessorInterface;
use Magento\Framework\Model\ResourceModel\Db\AbstractDb;
use Ewave\Navigation\Model\Menu as MenuItem;
use Magento\Framework\Model\ResourceModel\Db\Context;

/**
 * Class Processor
 * @package Ewave\AbstractAttributesNavigation\Model\ResourceModel
 */
class Processor extends AbstractDb implements SaveProcessorInterface
{
    ...
    {
        $mainTable = 'ewave_navigation_menu_entity';
        $select->joinLeft(
