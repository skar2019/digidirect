...
class Queue
{
    ...
    public function __construct(
        ...
        $this->intervalSecAttempts = (int)$this->scopeConfig->getValue('ewave_ai/queue/interval_of_attempts');
        $this->intervalSecAttemptsQueueDepends = (int)$this->scopeConfig->getValue(
            'ewave_ai/queue/interval_of_attempts_for_pending_depends'
        );
        $this->batchSize = (int)$this->scopeConfig->getValue('ewave_ai/queue/batch_size');
    }
