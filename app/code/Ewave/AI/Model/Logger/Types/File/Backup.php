...
use Ewave\AI\Helper\Logger as LogHelper;
...
{
    const XML_PATH_BACKUP_PATH = 'ewave_ai/logs/backup_logs_path';
    const XML_PATH_BACKUP_AFTER_X_DAYS = 'ewave_ai/logs/logs_files_backup_days';
