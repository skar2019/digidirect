...
use Ewave\AI\Api\QueueRepositoryInterface;
use Ewave\AI\Api\Data\QueueInterface;
use Ewave\AI\Model\ResourceModel\Queue\Queue as QueueResource;
use Ewave\AI\Model\ResourceModel\Queue\Queue\CollectionFactory as QueueCollectionFactory;
use Ewave\AI\Model\ResourceModel\Queue\Queue\Collection as QueueCollection;
...
class QueueRepository implements QueueRepositoryInterface
{
    ...
    public function storeRelatedLogId($queueId, $logId)
    {
        ...
        $connection->insertOnDuplicate(
            $this->resource->getTable('ewave_ai_queue_log'),
    ...
    public function get($queueId, $reload = false)
    {
        if (!isset($this->queuesById[$queueId]) || $reload) {
            /** @var \Ewave\AI\Model\Engine\Queue\Queue $queue */
    ...
    {
        /**
         * @var $existingQueueItem QueueInterface|\Ewave\AI\Model\Engine\Queue\Queue
         * @var $queue QueueInterface|\Ewave\AI\Model\Engine\Queue\Queue
