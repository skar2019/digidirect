...
namespace Ewave\AI\Model\Engine;

use Ewave\AI\Model\Engine\Exception\EngineException;
use Ewave\AI\Model\Engine\Exception\QueueDependsException;
...
class Engine extends DataObject
{
     ...
     * Helper Engine
     *
     * @var \Ewave\AI\Model\Engine\Mail\MailFactory
     */
    protected $_mailer;
     ...
     * LoggerFactory
     *
     * @var \Ewave\AI\Model\Logger\LoggerFactory
     */
     ...
     *
     * @var \Ewave\AI\Model\Engine\Processor\ProcessorFactoryFactory
     */
     ...
     * @param \Ewave\AI\Model\Logger\LoggerFactory $loggerFactory
     ...
     * @param \Ewave\AI\Helper\Queue $queueHelper
    ...
    public function __construct(
        ...
        \Ewave\AI\Model\Logger\LoggerFactory $loggerFactory,
        \Ewave\AI\Model\Engine\Processor\ProcessorFactoryFactory $processorFactory,
        \Magento\Framework\DataObjectFactory $dataObjectFactory,
        \Ewave\AI\Model\Integrations\ScheduleFactory $scheduleFactory,
        \Ewave\AI\Helper\Queue $queueHelper,
        $processCode,
        $initiator = null,
        $isCronRun = false,
        $queueId = null,
        ...
        /** @var  \Ewave\AI\Model\Engine\Processor\ProcessorFactory */
     ...
     * Run processor
     *
     * @see ewave_ai_integrations table
     * @return \Magento\Framework\DataObject
     * @throws \Exception
     */
    private function _run()
    {
        ...
        try {
            ...
            $this->_eventManager->dispatch(
                'ewave_ai_engine_get_processor_before_' . $this->_integration->getProcessCode(),
                ['engine' => $this]
            );

            $processor = $this->_getProcessor();

            $this->_eventManager->dispatch('ewave_ai_engine_process_run_before', ['processor' => $processor]);
            $this->_eventManager->dispatch(
                'ewave_ai_' . $this->_integration->getProcessCode() . '_run_before',
                [
                    'processor' => $processor,
                    'engine' => $this
                ]
            ...
            $this->_eventManager->dispatch('ewave_ai_engine_process_run_after', ['processor' => $processor]);
            $this->_eventManager->dispatch(
                'ewave_ai_' . $this->_integration->getProcessCode() . '_run_after',
                [
                    'processor' => $processor,
                    'engine' => $this
                ]
    ...
    protected function doOnCatch($e)
    {
        ...
        if (!$loggerException) {
            $this->_logger->addHeader(
                $fullMessage,
                \Ewave\AI\Helper\Logger::RECORD_TYPE_ERROR_CODE,
                Logger::LOG_PLACE_DB
            );
        }
        ...
        if ($sendEmail) {
            /**
             * @var $mailer \Ewave\AI\Model\Engine\Mail\Mail
             */
