...
namespace Ewave\AI\Model\ResourceModel\Queue;
 ...
 * Class Queue
 *
 * @package Ewave\AI\Model\ResourceModel\Queue
 */
class Queue extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function getActiveQueueItemIdByProcessCodeAndProcessData($processCode, $processData)
    {
        ...
        $select->from($this->getMainTable(), $this->getIdFieldName())
            ...
            ->where(QueueInterface::STATE . ' <> ?', \Ewave\AI\Model\Engine\Queue\State::STATE_CLOSED);
