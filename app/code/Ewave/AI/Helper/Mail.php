...
{
    const XML_PATH_FAIL_RUN_EMAIL_TEMPLATE = 'ewave_ai/exceptions/fail_run_email_template';
    const XML_PATH_FAIL_RUN_EMAILS = 'ewave_ai/exceptions/exceptions_emails';
    const XML_PATH_QUEUE_FAIL_EMAILS = 'ewave_ai/queue/fail_emails';
    const XML_PATH_QUEUE_FAIL_EMAIL_TEMPLATE = 'ewave_ai/queue/fail_email_template';
     ...
     * @var string
     */
    protected $globalFailEmailTemplate = 'ewave_ai_exceptions_global_fail_email_template';
