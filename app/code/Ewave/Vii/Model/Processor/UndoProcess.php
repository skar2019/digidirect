...
class UndoProcess extends \Ewave\Vii\Model\Processor\ProcessAbstract implements ProcessorInterface
{
    const PROCESS_CODE = 'ewave_vii_undo';
     ...
     * @throws \Ewave\AI\Model\Engine\Processor\Exception\ProcessException
    ...
    public function process()
    {
        ...
        try {
             ...
             * @var \Ewave\AbstractGiftCard\Api\AbstractGiftCardEntityInterface $entity
             */
