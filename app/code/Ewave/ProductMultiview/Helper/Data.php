<?php
namespace Ewave\ProductMultiView\Helper;
...
{
    const CONFIG_ENABLED = 'ewave_productmultiview/product_multi_view/enabled';

    const CONFIG_DISPLAY_RANDOM_HOVER = 'ewave_productmultiview/product_multi_view/display_random_hover';
