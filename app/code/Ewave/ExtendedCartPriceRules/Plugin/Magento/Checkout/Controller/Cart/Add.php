<?php
namespace Ewave\ExtendedCartPriceRules\Plugin\Magento\Checkout\Controller\Cart;
...
/**
 * Class Add
 * @package Ewave\ExtendedCartPriceRules\Plugin\Magento\Checkout\Controller\Cart
 */
class Add
{
    /**
