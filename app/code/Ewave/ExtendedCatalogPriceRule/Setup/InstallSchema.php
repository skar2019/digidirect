<?php
namespace Ewave\ExtendedCatalogPriceRule\Setup;
...
use Ewave\ExtendedCatalogPriceRule\Model\ResourceModel\ExtendedCatalogRule;
...
/**
 * Class UpgradeSchema
 * @package Ewave\ExtendedCatalogPriceRule\Setup
 */
class InstallSchema implements InstallSchemaInterface
{
    ...
    {
        $setup->startSetup();
        $this->addEwaveExtendedCatalogPriceRuleTable($setup);
        $setup->endSetup();
    }
     ...
     */
    public function addEwaveExtendedCatalogPriceRuleTable(SchemaSetupInterface $setup)
    {
