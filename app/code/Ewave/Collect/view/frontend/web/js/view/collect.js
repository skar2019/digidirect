define([
    ...
    'Ewave_Collect/js/model/shipping-address/form-popup-state',
    'Ewave_Collect/js/model/collect',
    'Ewave_Collect/js/action/set-collect-places'
    ...
    return Component.extend({
        defaults: {
            collectFormTemplate: 'Ewave_Collect/checkout/shipping-address/form'
        },
