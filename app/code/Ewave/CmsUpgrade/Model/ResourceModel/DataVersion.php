...
namespace Ewave\CmsUpgrade\Model\ResourceModel;

/**
 * Class DataVersion
 * @package Ewave\CmsUpgrade\Model\ResourceModel
 */
class DataVersion extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    const INSTALLED_FILES_TABLE = 'ewave_cms_upgrade_installed_files';
    ...
    {
        $this->_init('ewave_cms_upgrade_data_version', 'id');
    }
