...
class Delete extends \Ewave\ExtendedShippingRates\Controller\Adminhtml\ExtendedShippingRates\Carrier
{
    /**
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                /** @var \Ewave\ExtendedShippingRates\Model\Carrier $model */
