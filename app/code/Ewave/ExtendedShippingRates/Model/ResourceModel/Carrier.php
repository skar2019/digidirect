...
class Carrier extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function __construct(
        ...
        \Ewave\ExtendedShippingRates\Model\ResourceModel\Method\CollectionFactory $methodsCollectionFactory,
    ...
    {
        $deleteByStoreIds = [];
        $table = $this->getTable(\Ewave\ExtendedShippingRates\Model\Carrier::CARRIER_LABELS_TABLE_NAME);
    ...
    public function getStoreLabels($carrierId)
    {
        $select = $this->getConnection()->select()->from(
            $this->getTable(\Ewave\ExtendedShippingRates\Model\Carrier::CARRIER_LABELS_TABLE_NAME),
            ['store_id', 'label']
        )->where(
    ...
    {
        /** @var \Ewave\ExtendedShippingRates\Model\ResourceModel\Method\Collection $methods */
