<?php
namespace Ewave\ExtendedShippingRates\Block\Adminhtml\ExtendedShippingRates\Zone\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $formName = 'ewave_extendedshippingrates_zone_form';
        ...
        $renderer = $this->rendererFieldset->setTemplate(
            ...
            $this->getUrl(
                'ewave_extendedshippingrates/extendedshippingrates_zone/newConditionHtml/form/rule_conditions_fieldset'
            )
        );
