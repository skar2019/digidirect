...
namespace Ewave\Navigation\Helper;

use Ewave\Navigation\Model\Frontend\StoreResolver;
use Ewave\Navigation\Model\UrlParser;
...
{
    const EWAVE_NAVIGATION_CURRENT_SET_REGISTRY_KEY = 'current_navigation_set';
    ...
    {
        return substr($this->removeSpaces($link), 0, 4) == \Ewave\Navigation\Model\ResourceModel\Menu::PHONE_PREFIX;
    }
