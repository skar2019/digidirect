...
class Set extends AbstractDb
{
     ...
     *
     * @param \Ewave\Navigation\Model\Set $object
     * @return $this
     */
    protected function _saveStoreSet($object)
    {
        if ($object->getId()) {
            ...
            $setStoreTable = $this->getTable('ewave_navigation_menu_set_store');
            ...
            if (!empty($insert)) {
                ...
                $this->getConnection()->insertOnDuplicate(
                    $this->getTable('ewave_navigation_menu_set_store'),
                    $ids
                );
            }
        }
    ...
    public function getStoreIds($id)
    {
        $select = $this->getConnection()->select()
            ->from('ewave_navigation_menu_set_store', ['store_id'])
