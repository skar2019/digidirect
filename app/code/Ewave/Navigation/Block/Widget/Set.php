...
namespace Ewave\Navigation\Block\Widget;

use Ewave\Navigation\Block\MenuBlockInterface;
use Ewave\Navigation\Model\Frontend\CustomerSetInterface;
use Ewave\Navigation\Model\Frontend\CustomerSetMaker;
use Ewave\Navigation\Model\Frontend\MenuSetData;
use Ewave\Navigation\Model\Frontend\MenuSetDataFormatter;
use Ewave\Navigation\Model\UrlComparator;
...
class Set extends Template implements BlockInterface, MenuBlockInterface, IdentityInterface
{
    ...
    public function __construct(
        ...
        string $template = 'Ewave_Navigation::widget/default.phtml',
        array $data = []
    ) {
    ...
    /**
     * @return \Ewave\Navigation\Model\Frontend\CustomerSetInterface
     */
