...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    {
        $tableName = 'ewave_navigation_menu_item_store_relation';
            ...
            $table = $this->connection
                ...
                ->addColumn(
                    ...
                    $this->setup->getFkName(
                        $tableName,
                        'menu_entity_id',
                        'ewave_navigation_menu_entity',
                        'entity_id'
                    ),
                    'menu_entity_id',
                    $this->setup->getTable('ewave_navigation_menu_entity'),
                    'entity_id',
                    \Magento\Framework\DB\Ddl\Table::ACTION_CASCADE
                )->setComment(
                    'Ewave Menu Item Store Relation'
                );
    ...
    {
        $tableName = 'ewave_navigation_menu_item_info';
        ...
        if ($this->isTableExists($tableName) && $this->isColumnExists($tableName, 'is_logged_in')) {
            $this->connection->modifyColumn(
                ...
                $columnName,
                [
                    'default' => \Ewave\Navigation\Model\Menu::MENU_ITEM_FOR_ALL_USERS,
        ...
        $tableName = 'ewave_navigation_menu_entity';
