...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Ewave\Navigation\Model\SetFactory
     */
     ...
     * @param \Ewave\Navigation\Model\SetFactory $setFactory
    ...
    public function execute()
    {
        ...
        if ($data) {
            /** @var \Ewave\Navigation\Model\Set $model */
            ...
            try {
                ...
                $this->dataPersistor->clear(\Ewave\Navigation\Helper\Data::EWAVE_NAVIGATION_CURRENT_SET_REGISTRY_KEY);
            ...
            $this->dataPersistor->set(\Ewave\Navigation\Helper\Data::EWAVE_NAVIGATION_CURRENT_SET_REGISTRY_KEY, $data);
    ...
    {
        return $this->_authorization->isAllowed('Ewave_Navigation::navigation_menu_sets_save');
    }
}
