<?php
namespace Ewave\Faq\Model\ResourceModel\Faq\Relation\Tag;

use Ewave\Faq\Api\Data\FaqInterface;
use Ewave\Faq\Model\ResourceModel\Faq;
use Ewave\Faq\Model\ResourceModel\Tag;
...
class SaveHandler implements ExtensionInterface
{
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        if (!empty($needCreateTags)) {
            $table = $this->_resourceFaq->getTable('ewave_faq_tag');
            $data = [];
        ...
        $table = $this->_resourceFaq->getTable('ewave_faq_tag_relation');
