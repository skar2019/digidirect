<?php
namespace Ewave\Faq\Model\ResourceModel\Category\Relation\Store;

use Ewave\Faq\Api\Data\CategoryInterface;
use Ewave\Faq\Model\ResourceModel\Category;
...
class SaveHandler implements ExtensionInterface
{
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        $table = $this->resourcePage->getTable('ewave_faq_category_store');
