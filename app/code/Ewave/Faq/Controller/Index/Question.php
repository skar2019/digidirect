...
use Ewave\Faq\Model\Email\Admin;
...
{
    /**
     * @var \Ewave\Faq\Model\ResourceModel\FaqRepository
     */
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->dataPersistor->clear(\Ewave\Faq\Helper\Question::POST_VALUE_KEY);
        } catch (\Exception $e) {
            $this->messageManager->addErrorMessage(
                __('We can\'t process your request right now. Sorry, that\'s all we know.' . $e->getMessage())
            );
            $this->dataPersistor->set(\Ewave\Faq\Helper\Question::POST_VALUE_KEY, $post);
        }
