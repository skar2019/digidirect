...
namespace Ewave\Faq\Plugin\Faq\Model\ResourceModel;

use Magento\UrlRewrite\Model\UrlPersistInterface;
use Magento\CmsUrlRewrite\Model\CmsPageUrlPathGenerator;
use Magento\UrlRewrite\Service\V1\Data\UrlRewrite;
use Magento\Framework\Filter\FilterManager;
use Ewave\Faq\Helper\Data as FaqHelper;

/**
 * Before save and around delete plugin for \Ewave\Faq\Model\ResourceModel\Category:
...
class Category
{
     ...
     * Before save handler
     *
     * @param \Ewave\Faq\Model\ResourceModel\Category $subject
    ...
    public function beforeSave(
        \Ewave\Faq\Model\ResourceModel\Category $subject,
        \Magento\Framework\Model\AbstractModel $object
    ) {
        /** @var $object \Ewave\Faq\Model\Category */
        ...
        if ($category->isDeleted()) {
            $this->urlPersist->deleteByData(
                [
                    ...
                    UrlRewrite::ENTITY_TYPE => \Ewave\Faq\Model\Category::URL_REWRITE_ENTITY_TYPE,
                ]
            );
        }
     ...
     *
     * @param \Ewave\Faq\Model\ResourceModel\Category $faqCategory
     * @return string
     * @api
     */
