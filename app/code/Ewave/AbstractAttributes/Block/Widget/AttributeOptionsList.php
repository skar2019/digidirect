<?php
namespace Ewave\AbstractAttributes\Block\Widget;
...
use Ewave\AbstractAttributes\Model\Widget\Options\Template as TemplateModel;
    ...
    implements \Magento\Widget\Block\BlockInterface
{
    ...
    /**
     * @param OptionInterface $option
     * @return \Ewave\AbstractAttributes\Helper\Image
     */
     ...
     * @return \Ewave\AbstractAttributes\Api\Data\AbstractAttributeInterface|null
     */
    ...
    protected function _toHtml()
    {
        ...
        $this->setTemplate('Ewave_AbstractAttributes::widget/attribute_options/' . $templatePath);
