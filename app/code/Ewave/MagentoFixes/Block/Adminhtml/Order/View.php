...
namespace Ewave\MagentoFixes\Block\Adminhtml\Order;
 ...
 * @api
 * @package Ewave\MagentoFixes\Block\Adminhtml\Order
 */
class View extends OrderView
{
    ...
    {
        return $this->getUrl('ewave_paypal/paypal_express/authorization');
    }
