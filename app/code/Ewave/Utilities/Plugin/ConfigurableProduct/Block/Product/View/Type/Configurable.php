<?php
namespace Ewave\Utilities\Plugin\ConfigurableProduct\Block\Product\View\Type;
...
/**
 * Class Configurable
 * @package Ewave\Utilities\Plugin\ConfigurableProduct\Block\Product\View\Type
 */
class Configurable
{
    /**
