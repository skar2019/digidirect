...
use Ewave\Utilities\Block\View\Element\Message\Renderer\CustomizedMessageFactory;
...
class ExtendedRenderer implements RendererInterface
{
    ...
    /**
     * @var \Ewave\Utilities\Helper\Message
     */
     ...
     * @param \Ewave\Utilities\Helper\Message $_messageHelper
     * @param CustomizedMessageFactory $customizedMessageFactory
     * @param string $textRendererTemplate
     */
    public function __construct(
        Template $_template,
        \Ewave\Utilities\Helper\Message $_messageHelper,
        CustomizedMessageFactory $customizedMessageFactory,
        $textRendererTemplate = 'Ewave_Utilities::messages/text.phtml'
    ) {
