...
namespace Ewave\FreeGift\Test\Unit\Model\Cart;
...
class ItemTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_itemModel = $this->_objectManager->getObject('Ewave\FreeGift\Model\Cart\Item', []);
    }
    ...
    public function testGetRuleIdNoRule()
    {
        $this->_quoteItem->expects($this->any())
            ->method('getData')
            ->with(\Ewave\FreeGift\Model\Cart\Item::FREE_GIFT_KEY)
            ->willReturn(0);
    ...
    public function testGetRuleId()
    {
        $this->_quoteItem->expects($this->any())
            ...
            ->willReturn([
                'options' => [
                    \Ewave\FreeGift\Model\Cart\Item::FREE_GIFT_KEY => 30
                ]
            ]);
