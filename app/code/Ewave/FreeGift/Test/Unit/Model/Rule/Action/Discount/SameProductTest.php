...
class SameProductTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Ewave\FreeGift\Model\Rule\Action\Discount\SameProduct
     */
    ...
    {
        $this->_giftItem = $this->getMockBuilder('Ewave\FreeGift\Model\Cart\Item')
            ->disableOriginalConstructor()
            ->getMock();

        $this->_giftCart = $this->getMockBuilder('Ewave\FreeGift\Model\Cart')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->_sameProductActionModel = $this->_objectManager->getObject(
            'Ewave\FreeGift\Model\Rule\Action\Discount\SameProduct',
            [
