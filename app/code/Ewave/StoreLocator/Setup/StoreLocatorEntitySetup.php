...
use Ewave\Store\Setup\StoreEntitySetup;
...
use Ewave\StoreLocator\Helper\Config as CongigHelper;
...
class StoreLocatorEntitySetup extends StoreEntitySetup
{
    ...
    public function upgradeData(ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '1.0.6', '<')) {
            $this->updateAttribute(
                ...
                CongigHelper::ATTRIBUTE_FEATURED,
                'source_model',
                'Ewave\StoreLocator\Model\Config\Entity\Attribute\Source\Noyes'
            );
        }
    ...
    protected function moveWrongValues()
    {
        ...
        $oldTableName = $this->getSetup()->getTable('ewave_abstractentity_entity_varchar');
        $newTableName = $this->getSetup()->getTable('ewave_abstractentity_entity_text');
