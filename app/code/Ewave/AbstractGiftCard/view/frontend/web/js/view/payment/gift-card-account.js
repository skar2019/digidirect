define([
    ...
    'Ewave_AbstractGiftCard/js/action/set-gift-card-information',
    'Ewave_AbstractGiftCard/js/action/get-gift-card-information',
    'Magento_Checkout/js/model/totals',
    'Ewave_AbstractGiftCard/js/model/gift-card',
    'mage/validation'
], function (
    $,
    _,
    ...
    return Component.extend({
        defaults: {
            template: 'Ewave_AbstractGiftCard/payment/gift-card-account',
            giftCardPin: '',
            serviceCode: 'default',
            isPin: false,
            isCheckBalance: true,
