...
use Ewave\AbstractGiftCard\Block\Form;
use Ewave\AbstractGiftCard\Model\InfoInterface;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    /**
     * @var \Ewave\AbstractGiftCard\Model\Config
     */
     ...
     *
     * @var \Ewave\AbstractGiftCard\Model\Service\Factory
     */
     ...
     * @param \Ewave\AbstractGiftCard\Model\Service\Factory $serviceFactory
     * @param \Magento\Store\Model\App\Emulation $appEmulation
     * @param \Ewave\AbstractGiftCard\Model\Config $serviceConfig
     * @param \Magento\Framework\App\Config\Initial $initialConfig
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        LayoutFactory $layoutFactory,
        \Ewave\AbstractGiftCard\Model\Service\Factory $serviceFactory,
        \Magento\Store\Model\App\Emulation $appEmulation,
        \Ewave\AbstractGiftCard\Model\Config $serviceConfig,
    ...
    public function isNativeGiftCardsAllowed()
    {
        if ($this->isActive()) {
            return $this->scopeConfig->isSetFlag(
                'ewave_abstract_gift_card/settings/allow_native_gift_cards',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            );
        }
        return true;
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'ewave_abstract_gift_card/settings/active',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    {
        return $this->scopeConfig->isSetFlag(
            'ewave_abstract_gift_card/settings/accept_gift_cards_for_paid_orders',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
