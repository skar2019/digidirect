<?php
namespace Ewave\LayeredNavigation\Test\Unit\Model\ResourceModel\Fulltext;
...
{
    /**
     * @var \Ewave\LayeredNavigation\Model\ResourceModel\Fulltext\Collection
     */
    ...
    public function setUp()
    {
        $reflectionOfCollection = new \ReflectionClass(
            '\Ewave\LayeredNavigation\Model\ResourceModel\Fulltext\Collection'
        );
        ...
        $this->_requestBuilder = $this->getMockBuilder('\Ewave\LayeredNavigation\Model\Request\Builder')
            ->setMethods(['autoSetRequestName', 'create'])
            ->disableOriginalConstructor()
            ->getMock();

        $this->_helper = $this->getMockBuilder('\Ewave\LayeredNavigation\Helper\Data')
