define(['module', 'exports', './../models/index', './../common/store', 'ewaveUtils'], function (module, exports, _index, _store, _ewaveUtils) {
    'use strict';
    ...
    var Component = function () {
        function Component(options) {
            ...
            (0, _ewaveUtils.loadView)(this.options, this, 'Ewave_LayeredNavigation/js/dist/views/index', 'LayeredNavigation');
        ...
        _createClass(Component, [{
            ...
            value: function loadFilter(filterName, options) {
                var FILTERS_FOLDER = 'Ewave_LayeredNavigation/js/dist/views/filters/';
