<?php
namespace Ewave\AbstractEntity\Model\AbstractEntity\Attribute\Source;
 ...
 */
class Status extends AbstractSource implements SourceInterface, OptionSourceInterface, ArrayInterface
{
    /**#@+
