...
use Ewave\AbstractEntity\Model\AttributeSet\UrlProcessor;
use Ewave\AbstractEntity\Api\Data\AbstractEntityInterface;
use Ewave\AbstractEntity\Model\AttributeSet\UrlProcessorFactory;
use \Magento\Framework\Model\ResourceModel\Db\Context;
use \Ewave\AbstractEntity\Model\RelationInterface;
...
class AdditionalAttributes extends AbstractDb implements RelationInterface
{
    ...
    {
        $this->_init('ewave_abstractentity_entity_additional_attributes', AbstractEntityInterface::ATTRIBUTE_SET_ID);
    }
