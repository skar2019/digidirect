...
class LocationRepository implements LocationRepositoryInterface
{
    ...
    public function __construct(
        \Ewave\AddressVerification\Model\ResourceModel\Location $resourceModel,
        \Ewave\AddressVerification\Model\ResourceModel\Location\CollectionFactory $collectionFactory
    ) {
    ...
    {
        /** @var \Ewave\AddressVerification\Model\ResourceModel\Location\Collection $collection */
