Ewave Address Autocomplete
=====================

[wiki link](https://wiki.ewave.com/display/LEGO/Address+Autocomplete)
...
1.  <update handle="ewave_address_autocomplete_config" />
2. Configure fields mapping in xml(for example):

        <referenceBlock name="ewave_address_autocomplete">
            <arguments>
