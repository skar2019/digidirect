...
use Ewave\GiftCardImage\Model\Media\Config as MediaConfig;
 ...
 * @package Ewave\AbstractAttributes\Model\Media
 */
class ImageProcessor
{
    /**
    ...
    protected function upload($destination, $fileId = null)
    {
        ...
        $uploader = $this->uploaderFactory->create(['fileId' => $fileId ?: ImageHelper::IMAGE_ID]);
