...
namespace Ewave\ShippingAvailabilityCheck\Block\AvailabilityCheck;

use Magento\Framework\Exception\NoSuchEntityException;

/**
 * Class Form
 * @package Ewave\ShippingAvailabilityCheck\Block\AvailabilityCheck
...
class Form extends \Magento\Directory\Block\Data
{
    ...
    public function __construct(
        ...
        array $data = [],
        \Ewave\ShippingAvailabilityCheck\Helper\Data $dataHelper = null
    ) {
        parent::__construct(
            $context,
            $directoryHelper,
        ...
        $this->dataHelper = $dataHelper ?: \Magento\Framework\App\ObjectManager::getInstance()
            ->get(\Ewave\ShippingAvailabilityCheck\Helper\Data::class);
    }
