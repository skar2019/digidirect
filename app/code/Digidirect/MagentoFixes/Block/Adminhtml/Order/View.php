...
namespace Digidirect\MagentoFixes\Block\Adminhtml\Order;
 ...
 * @api
 * @package Digidirect\MagentoFixes\Block\Adminhtml\Order
 */
class View extends OrderView
{
    ...
    {
        return $this->getUrl('digidirect_paypal/paypal_express/authorization');
    }
