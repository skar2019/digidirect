define(['module', 'exports', './../models/index', './store', 'digidirectUtils'], function (module, exports, _index, _store, _digidirectUtils) {
    ...
    var Component = function () {
        function Component(options) {
            ...
            (0, _digidirectUtils.loadView)(this.options, this, 'Digidirect_Faq/js/dist/views/index', 'FAQ');
        ...
        _createClass(Component, [{
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                ...
                                case 11:
                                    ...
                                    console.warn('FAQ request failed', _context.t0);
            ...
            value: function watchers(options) {
                ...
                _store.Store.on(_store.Events.DATA_FETCH_START, function (url, realUrl) {
            ...
            key: 'updateBrowserHistoryState',
            value: function updateBrowserHistoryState(fetchOptions) {
                if (fetchOptions !== undefined && fetchOptions.realUrl) {
                    var url = fetchOptions.realUrl;
