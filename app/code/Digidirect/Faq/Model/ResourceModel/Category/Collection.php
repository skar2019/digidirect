<?php
namespace Digidirect\Faq\Model\ResourceModel\Category;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('Digidirect\Faq\Model\Category', 'Digidirect\Faq\Model\ResourceModel\Category');
    }
    ...
    {
        $this->_performAfterLoad('digidirect_faq_category_store', 'category_id');
    ...
    public function addFilterByStoreId($storeId)
    {
        ...
        $this->getSelect()
            ->joinInner(
                ['fcs' => $this->getTable('digidirect_faq_category_store')],
