...
class Category extends \Magento\Framework\Model\AbstractModel implements CategoryInterface, IdentityInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'digidirect_faq_category';
     ...
     * @param \Digidirect\Faq\Helper\Data $helper
     */
    public function __construct(
        ...
        \Digidirect\Faq\Model\ResourceModel\Category\CollectionFactory $resourceCollectionFactory,
        \Digidirect\Faq\Helper\Data $helper
    ) {
