...
namespace Digidirect\Faq\Helper;

use Magento\Store\Model\ScopeInterface;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const FAQ_URL = 'digidirect_faq/general/faq_page_url';
    const FAQ_SUFFIX = 'digidirect_faq/general/main_url_suffix';
    const FAQ_CATEGORY_SUFFIX = 'digidirect_faq/general/category_url_suffix';
    const FAQ_ENABLED = 'digidirect_faq/general/faq_enabled';
    const FAQ_PERPAGE = 'digidirect_faq/general/faq_per_page';
    const FAQ_TAG_ENABLE = 'digidirect_faq/general/faq_tag_enable';
    const FAQ_SEARCH_ENABLE = 'digidirect_faq/general/faq_search_enable';
    ...
    {
        return $this->scopeConfig->isSetFlag('digidirect_faq/general/ajax_category', ScopeInterface::SCOPE_STORE);
    }
    ...
    {
        if(!empty($this->scopeConfig->getValue(static::FAQ_SUFFIX)))
        {
