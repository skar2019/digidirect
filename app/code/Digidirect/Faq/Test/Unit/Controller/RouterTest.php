<?php
namespace Digidirect\Faq\Test\Unit\Controller;

use Digidirect\Faq\Test\Unit\FaqTestUnitTrait;

/**
 * Class RouterTest
 * @package Digidirect\Faq\Test\Unit\Controller
 */
class RouterTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Digidirect\Faq\Controller\Router
     */
    protected $_model;
    ...
    public function testMatch()
    {
        ...
        $faqHelper = $this->getMockObjectWithoutConstructor('Digidirect\Faq\Helper\Data', ['isModuleEnabled', 'isValidUrl']);
        $faqHelper->method('isModuleEnabled')->willReturn(1);
        $faqHelper->method('isValidUrl')->willReturn(true);

        $this->_model = $helper->getObject(
            'Digidirect\Faq\Controller\Router',
            [
