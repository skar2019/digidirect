...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    {
        $tableName = 'digidirect_faq_category';
    ...
    {
        $setup->getConnection()->dropColumn('digidirect_faq', 'metakeyword');
        $setup->getConnection()->addColumn(
            $setup->getTable('digidirect_faq'),
            'metatitle',
            [
    ...
    {
        $setup->getConnection()->addColumn(
            $setup->getTable('digidirect_faq_category'),
            'identifier',
            [
                'type' => \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
                'length' => 255,
