...
/**
 * Class EditBackAttribute
 * @package Digidirect\AbstractAttributes\Controller\Adminhtml\Option
 */
class NewBackAttribute extends \Magento\Backend\App\Action
{
    /**
    ...
    /**
     * Create new option and back to attribute edit
