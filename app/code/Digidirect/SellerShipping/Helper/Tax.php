...
{
    const XML_PATH_TAX_ENABLED = 'SellerShipping/tax/enable';
    const XML_PATH_TAX_CLASS   = 'SellerShipping/tax/tax_class';
    const XML_PATH_TAX_DISPLAY = 'SellerShipping/tax/display';
