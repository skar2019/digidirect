...
use Digidirect\Feed\Api\ImageHelperInterface;
use Digidirect\Feed\Model\ImageFactory;
...
class Image extends AbstractHelper implements ImageHelperInterface
{
    ...
    /**
     * @var \Digidirect\Feed\Model\Image
     */
    protected $model;
     ...
     * Image Model
     *
     * @param \Digidirect\Feed\Model\Image $model
     * @return $this
     */
     ...
     * Image model
     *
     * @return \Digidirect\Feed\Model\Image
     */
