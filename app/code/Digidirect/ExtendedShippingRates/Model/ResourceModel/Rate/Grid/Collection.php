<?php
namespace Digidirect\ExtendedShippingRates\Model\ResourceModel\Rate\Grid;

use Digidirect\ExtendedShippingRates\Model\ResourceModel\Rate\Collection as RateCollection;
 ...
 * Class Collection
 *
 * @package Digidirect\ExtendedShippingRates\Model\ResourceModel\Rate\Grid
...
class Collection extends RateCollection implements SearchResultInterface
{
    ...
    {
        $sessionMethodId = $this->session->getData('digidirect_current_sMethod_id');
