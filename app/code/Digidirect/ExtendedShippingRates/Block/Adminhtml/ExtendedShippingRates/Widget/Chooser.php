<?php
namespace Digidirect\ExtendedShippingRates\Block\Adminhtml\ExtendedShippingRates\Widget;
...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $this->_eventManager->dispatch(
            'adminhtml_block_extendedshippingrates_widget_chooser_prepare_collection',
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl(
            'digidirect_extendedshippingrates/extendedshippingrates_quote/chooser',
            ['uniq_id' => $uniqId]
        );
        ...
        if ($element->getValue()) {
            $rule = $this->ruleRepository->getById((int)$element->getValue());
            if ($rule->getId()) {
    ...
    {
        return $this->getUrl('digidirect_extendedshippingrates/extendedshippingrates_quote/chooser', ['_current' => true]);
    }
}
