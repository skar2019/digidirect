    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $renderer = $this->rendererFieldset->setTemplate(
            ...
            $this->getUrl(
                'digidirect_extendedshippingrates/extendedshippingrates_quote/newConditionHtml/form/rule_conditions_fieldset'
            )
        );
        ...
        $this->setConditionFormName($model->getConditions(), QuoteDataProvider::FORM_NAME);
        $this->setForm($form);
