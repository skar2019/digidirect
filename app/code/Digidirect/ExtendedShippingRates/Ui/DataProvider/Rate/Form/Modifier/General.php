...
use Digidirect\ExtendedShippingRates\Model\ResourceModel\Method\CollectionFactory as MethodCollectionFactory;
...
class General extends AbstractModifier
{
    ...
    public function modifyData(array $data)
    {
        ...
        $submitUrl = $this->urlBuilder->getUrl(
            'digidirect_extendedshippingrates/extendedshippingrates_rate/save',
            $actionParameters
        );
    ...
    {
        /** @var \Digidirect\ExtendedShippingRates\Model\ResourceModel\Method\Collection $methodCollection */
