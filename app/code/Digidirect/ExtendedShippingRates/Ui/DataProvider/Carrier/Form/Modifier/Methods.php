...
class Methods extends AbstractModifier
{
     ...
     * @var string
     */
    const URL_PATH_NEW = 'digidirect_extendedshippingrates/extendedshippingrates_method/new';
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'digidirect_extendedshippingrates/extendedshippingrates_method/edit';
     ...
     * @var string
     */
    const URL_PATH_DELETE = 'digidirect_extendedshippingrates/extendedshippingrates_method/delete';
                ...
                'data' => [
                    'config' => [
                        ...
                        'actions' => [
                            [
                                'targetName' =>
                                    'digidirect_extendedshippingrates_carrier_form.digidirect_extendedshippingrates_carrier_form',
    ...
    {
        $carrierFormDataSource = 'digidirect_extendedshippingrates_carrier_form_data_source';
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Digidirect_ExtendedShippingRates/js/dynamic-rows/method-dynamic-rows-grid',
                        ...
                        'sortOrder' => $sortOrder,
                        'provider' => 'digidirect_extendedshippingrates_carrier_form.' . $carrierFormDataSource,
                ...
                'arguments' => [
                    'data' => [
                        'config' => [
                            ...
                            'template' => 'Digidirect_ExtendedShippingRates/components/actions-list',
                            'label' => __('Actions'),
                            'fit' => true,
                        ],
                    ],
