<?php
namespace Digidirect\ExtendedShippingRates\Ui\DataProvider\Quote\Form;

use Digidirect\ExtendedShippingRates\Model\ResourceModel\Rule\CollectionFactory;
...
class QuoteDataProvider extends AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        foreach ($items as $rule) {
            $rule->getResource()->loadCustomerGroupIds($rule);
            $this->data[$rule->getId()] = $rule->getData();
            $this->data[$rule->getId()]['single_store'] = $isSingleStore;
        }
