...
class CarrierActions extends Column
{
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'digidirect_extendedshippingrates/extendedshippingrates_carrier/edit';
     ...
     * @var string
     */
    const URL_PATH_DELETE = 'digidirect_extendedshippingrates/extendedshippingrates_carrier/delete';
