...
class Aliases
{
     ...
     */
    const CATEGORY_INFORMATION_TABLE_ALIAS = Category::EWAVE_BLOG_CATEGORY_INFORMATION_TABLE;
     ...
     */
    const CATEGORY_ENTITY_TABLE_ALIAS = Category::EWAVE_BLOG_CATEGORY_TABLE;
}
