    ...
    var View = function () {
        ...
        _createClass(View, [{
            ...
            value: function loadAction() {
                ...
                require(['./Digidirect_Navigation/js/dist/views/actions/' + actionString + '/action'], function (Action) {
            ...
            value: function loadOffCanvas() {
                ...
                var OFFCANVAS_PATH = 'Digidirect_Navigation/js/dist/views/actions/common/offcanvas';
