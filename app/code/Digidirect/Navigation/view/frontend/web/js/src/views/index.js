...
export default class View {
    ...
    loadAction () {
        ...
        require([`./Digidirect_Navigation/js/dist/views/actions/${actionString}/action`], (Action) => {
     ...
     */
    loadOffCanvas () {
        const OFFCANVAS_PATH = 'Digidirect_Navigation/js/dist/views/actions/common/offcanvas';
