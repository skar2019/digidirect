<?php
namespace Digidirect\Navigation\Test\Unit\Block\Adminhtml\Menu\Edit;
 ...
 * @package Digidirect\Navigation\Test\Unit\Block\Adminhtml\Menu\Edit
 */
class DeleteButtonTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Digidirect\Navigation\Block\Adminhtml\Menu\Edit\DeleteButton
     */
    ...
    public function setUp()
    {
        ...
        $this->_deleteButton = $this->_objectManager->getObject(
            'Digidirect\Navigation\Block\Adminhtml\Menu\Edit\DeleteButton',
    ...
    public function testGetButtonData($data, $expected)
    {
        ...
        $menuItemReflection = new \ReflectionClass(\Digidirect\Navigation\Model\Menu::class);
