<?php
namespace Digidirect\Navigation\Test\Unit\Model\ResourceModel;
...
/**
 * Class MenuTest
 * @package Digidirect\Navigation\Test\Unit\Model\ResourceModel
 */
class MenuTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Digidirect\Navigation\Model\ResourceModel\Menu
     */
    ...
    public function testValidate($data, $expected)
    {
        ...
        $this->_resourcesMock->expects($this->any())
            ->method('getTableName')
            ->willReturn('digidirect_navigation_menu_item_info');
