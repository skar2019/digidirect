<?php
namespace Digidirect\Navigation\Test\Unit\Controller\Adminhtml\Set;

use Digidirect\Navigation\Test\Unit\NavigationTestUnitTrait;

/**
 * Class SaveTest
 * @package Digidirect\Navigation\Test\Unit\Controller\Adminhtml\Set
 */
class SaveTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInitSet($data, $expected)
    {
        ...
        $setFactory = $this->getMockObjectWithoutConstructor('Digidirect\Navigation\Model\SetFactory', ['create']);

        $set = $this->getMockObjectWithoutConstructor('Digidirect\Navigation\Model\Set', ['getId']);

        $setRepository = $this->getMockObjectWithoutConstructor('Digidirect\Navigation\Model\SetRepository', ['getById']);
        ...
        $reflection = $this->_createReflectionClass('Digidirect\Navigation\Controller\Adminhtml\Set\Save');
