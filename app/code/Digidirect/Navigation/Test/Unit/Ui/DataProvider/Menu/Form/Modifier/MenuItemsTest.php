...
/**
 * Class MenuItemsTest
 * @package Digidirect\Navigation\Test\Unit\Ui\DataProvider\Menu\Form\Modifier
 */
class MenuItemsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_menuItemsCollectionFactoryMock = $this->getMockObjectWithoutConstructor(
            'Digidirect\Navigation\Model\ResourceModel\Menu\Grid\CollectionFactory',
            [
                'create'
            ]
        );
        ...
        $this->_setItemsCollectionFactoryMock = $this->getMockObjectWithoutConstructor(
            'Digidirect\Navigation\Model\ResourceModel\Set\Grid\CollectionFactory',
            [
                'create'
            ]
        );
        ...
        $this->_setCollectionMock = $this->getMockObjectWithoutConstructor(
            'Digidirect\Navigation\Model\ResourceModel\Set\Collection',
            [
                'addFieldToFilter',
                'setCurrentStoreId',
                '_beforeLoad',
        ...
        $this->_menuItemsModifier = $this->_objectManager->getObject(
            'Digidirect\Navigation\Ui\DataProvider\Menu\Form\Modifier\MenuItems',
            [
    ...
    protected function _getSetItem($id, $name)
    {
         ...
         */
        $menuItem = $this->getMockObjectWithoutConstructor(
            'Digidirect\Navigation\Model\Set',
            [
                'getId',
                'getName'
            ]
