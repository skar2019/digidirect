<?php
namespace Digidirect\Navigation\Test\Unit;

/**
 * Trait NavigationTestUnitTrait
 * @package Digidirect\Navigation\Test\Unit
 */
trait NavigationTestUnitTrait
{
    /**
    ...
    /**
     * Get menu model mock as used very often
     *
     * @param array $methods
     * @return \PHPUnit_Framework_MockObject_MockObject
     */
    protected function _getMenuItemModelMockWithoutConstructor($methods = [])
    {
        return $this->getMockObjectWithoutConstructor('Digidirect\Navigation\Model\Menu', $methods);
    }
