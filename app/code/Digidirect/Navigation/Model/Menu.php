...
use Digidirect\Navigation\Api\Data\MenuItemInformationInterface;
use Digidirect\Navigation\Api\Data\MenuItemInterface;
use Digidirect\Navigation\Model\Menu\CustomOptions;
...
use Digidirect\Navigation\Model\ResourceModel\Menu as MenuResourceModel;

/**
 * @property \Digidirect\Navigation\Model\ResourceModel\Menu $_resource
...
class Menu extends AbstractModel implements IdentityInterface, MenuItemInterface, MenuItemInformationInterface
{
    ...
    const CACHE_TAG = 'digidirect_navigation_menu_item';
    ...
    {
        $this->_init('Digidirect\Navigation\Model\ResourceModel\Menu');
    }
    ...
    /**
     * @return \Digidirect\Navigation\Model\Menu\Type\MenuDataInterface
     */
    protected function _getTypeInstance()
    {
        if (!isset($this->typeModel[$this->getTypeCode()])) {
            ...
            if (!($instance instanceof \Digidirect\Navigation\Model\Menu\Type\MenuDataInterface)) {
                throw new \InvalidArgumentException(
                    __('Menu type object must implement \Digidirect\Navigation\Model\Menu\Type\MenuDataInterface')
                );
            }
