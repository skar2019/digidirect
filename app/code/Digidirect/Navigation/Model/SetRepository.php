...
use Digidirect\Navigation\Api\Data;
use Digidirect\Navigation\Api\SetRepositoryInterface;
use Digidirect\Navigation\Model\ResourceModel\Set as ResourceSet;
...
class SetRepository implements SetRepositoryInterface
{
    ...
    /**
     * @var \Digidirect\Navigation\Api\Data\SetInterfaceFactory
     */
    ...
    public function __construct(
        ...
        \Digidirect\Navigation\Api\Data\SetInterfaceFactory $dataSetFactory,
    ...
    public function getList(SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $setModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $setData,
                $setModel->getData(),
                'Digidirect\Navigation\Api\Data\SetInterface'
            );
