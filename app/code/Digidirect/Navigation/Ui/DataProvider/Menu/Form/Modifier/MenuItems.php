...
use Digidirect\Navigation\Model\ResourceModel\Set\Grid\CollectionFactory as SetCollectionFactory;
...
class MenuItems extends MenuModifier
{
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'formElement' => 'select',
                        'componentType' => 'field',
                        'component' => 'Digidirect_Navigation/js/component/tree-dropdown',
                        'filterOptions' => true,
                        'chipsEnabled' => true,
                        'disableLabel' => true,
                        'levelsVisibility' => '1',
                        'elementTmpl' => 'Digidirect_Navigation/grid/filters/elements/ui-select',
    ...
    protected function _getMenuTree()
    {
        ...
        /**
         * @var $collection \Digidirect\Navigation\Model\ResourceModel\Menu\Grid\Collection
         */
