define(['module', 'exports', 'jquery', './../index', 'text!Digidirect_InfiniteScroll/template/catalog-search/button.html', './../actions/update-amount', 'Magento_Customer/js/customer-data'], function (module, exports, _jquery, _index, _button, _updateAmount, _customerData) {
    'use strict';
    ...
    var ViewCustom = function (_View) {
        ...
        _createClass(ViewCustom, [{
            ...
            value: function progress() {
                _get(ViewCustom.prototype.__proto__ || Object.getPrototypeOf(ViewCustom.prototype), 'progress', this).call(this);
                var self = this;
