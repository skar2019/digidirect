...
namespace Digidirect\AbstractEntity\Model\AttributeSet;
...
/**
 * Class UrlProcessor
 * @package Digidirect\AbstractEntity\Model\AttributeSet
 */
class UrlProcessor
{
    const URL_ENTITY_TYPE = 'set';
    const ROUTE_PATH = 'Digidirect_abstractentity/set/view';
