...
use Digidirect\AbstractEntity\Model\ResourceModel\Eav\Attribute as AbstractEntityEavAttribute;
...
class AbstractEntity extends \Magento\Eav\Model\Entity\AbstractEntity
{
    ...
    {
        if (empty($this->_type)) {
            $this->setType(\Digidirect\AbstractEntity\Model\AbstractEntity::ENTITY_TYPE);
        }
     ...
     * @param \Digidirect\AbstractEntity\Model\ResourceModel\Eav\Attribute|AbstractAttribute $attribute
     * @param mixed $value
     * @return $this
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    ...
    public function validate($object)
    {
        ...
        $entityType = $this->typeFactory->create()->loadByCode(\Digidirect\AbstractEntity\Model\AbstractEntity::ENTITY_TYPE);
