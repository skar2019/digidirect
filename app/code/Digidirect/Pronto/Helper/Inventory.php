...
class Inventory extends AbstractHelper
{
    ...
    */
    ...
    public function makeACurlRequest() {
        ...
        $url = 'https://digi-pronto.abtonline.com.au:8083/rest/abtws/stock-master?call-type=change_enquiry&check-warehouse-change=Y&date-time-change-min=27032021000000&check-price-change=Y';
        ...
        $retail = $json['stockmaster']['stockcode']['pricing']['price-region']['prc-recommend-retail-inc-tax'];
        $sku =  $json['stockmaster']['stockcode']['code'];
        echo "SKU : ". $sku;
        //pricing
        ...
        //loop from
        foreach ($json['stockmaster']['stockcode']['warehouse']['whse'] as $qt)
        {
