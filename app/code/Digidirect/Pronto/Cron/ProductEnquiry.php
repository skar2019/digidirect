...
class ProductEnquiry
{
    ...
    {
        $this->logger->info('Pronto Product Sync', array['info' => 'syncing set 2');
    ...
    {
        $this->logger->info('Pronto Product Sync', array['inf' => 'syncing set 5');
    ...
    {
        $this->logger->info('Pronto Product Sync', array['inf' => 'syncing set 6');
    ...
    {
        $this->logger->info('Pronto Product Sync', array['inf' => 'syncing set 7');
