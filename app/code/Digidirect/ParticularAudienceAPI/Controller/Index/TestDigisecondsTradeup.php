...
class TestDigisecondsTradeup extends Action implements HttpPostActionInterface {
    ...
    */
    public function execute()
    {
        ...
        $getRecommendationsUrl = "https://api-recs.particularaudience.com/3.0/recommendations?currentUrl=https://www.digidirect.com.au/pa-digiseconds-trade-up&expandProductDetails=true".$customerIdParam;
