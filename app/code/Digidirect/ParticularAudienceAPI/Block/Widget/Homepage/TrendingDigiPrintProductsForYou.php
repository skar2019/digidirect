...
class TrendingDigiPrintProductsForYou extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    ...
    public function getWidgetTitle() {
        return 'Trending digiPrint Products For You';
    }

    public function getWidgetClass() {
        return 'trending-digiprint-products-for-you-widget';
    }

    public function getViewAllLink() {
        return 'https://www.digidirect.com.au/digiprint';
    }
    ...
    public function getRecommendedProducts(){
        ...
        $paWidgetId = 'd659416a-40f6-ee11-abf3-02bf4bf6447c';
