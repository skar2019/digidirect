...
class TrendingDigiSecondsProductsForYou extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    ...
    public function getWidgetTitle() {
        return 'Trending digiSeconds Products For You';
    }

    public function getWidgetClass() {
        return 'trending-digiseconds-products-for-you-widget';
    }

    public function getViewAllLink() {
        return 'https://www.digidirect.com.au/digiseconds';
    }
    ...
    public function getRecommendedProducts(){
        ...
        $paWidgetId = 'f61e5e9b-4500-ef11-abf3-02bf4bf6447c';
