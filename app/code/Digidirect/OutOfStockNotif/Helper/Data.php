<?php
namespace Digidirect\OutOfStockNotif\Helper;
...
use Digidirect\OutOfStockNotif\Model\StockResolver;

/**
 * Class Data
 *
 * @package Digidirect\OutOfStockNotif\Helper
 */
class Data extends AbstractHelper
{
    const XML_PATH_IS_ENABLED_FOR_GUEST = 'digidirect_outofstocknotif/stock_subscription/enabled_for_guest';
    const XML_PATH_IS_ENABLED_FOR_BACKORDER = 'digidirect_outofstocknotif/stock_subscription/enabled_for_backorder';
