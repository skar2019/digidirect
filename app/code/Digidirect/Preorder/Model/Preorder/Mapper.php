 ...
 * Class Mapper
 *
 * @package Digidirect\PreOrder\Model\Preorder
 */
class Mapper
{
    /**
    ...
    /**
     * @var \Digidirect\PreOrder\Model\Preorder\PreorderModel[]
     */
    protected $preorders;
     ...
     * @return \Digidirect\PreOrder\Api\PreorderInterface
     ...
     *
     * @param \Digidirect\PreOrder\Model\Preorder\PreorderModel[] $preorders
     * @return \Digidirect\PreOrder\Model\Preorder\PreorderModel[]
    ...
    public function processPreordersSettings($preorders)
    {
        ...
        /** @var \Digidirect\PreOrder\Model\Preorder\PreorderModel $preorder */
