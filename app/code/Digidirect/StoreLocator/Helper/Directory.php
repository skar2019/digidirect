...
{
    const XML_PATH_DEFAULT_COUNTRY = 'digidirect_storelocator_config/list_settings/default_country';
    const XML_PATH_AVAILABLE_COUNTRIES = 'digidirect_storelocator_config/list_settings/available_countries';
