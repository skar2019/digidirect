...
class SpentTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var \Digidirect\FreeGift\Model\Rule\Action\Discount\Spent
     */
    protected $_spentActionModel;
    ...
    public function setUp()
    {
        ...
        $this->_quoteItem = $this->getMockBuilder('Magento\Quote\Model\Quote\Item')
            ->setMethods(['getBaseRowTotal', 'getQuote', 'getProduct'])
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->_spentActionModel = $this->_objectManager->getObject(
            'Digidirect\FreeGift\Model\Rule\Action\Discount\Spent',
            [
    ...
    public function testCalculate()
    {
        ...
        $this->_spentActionModel->calculate($this->_salesRule, $this->_quoteItem, 1);
    }
}
