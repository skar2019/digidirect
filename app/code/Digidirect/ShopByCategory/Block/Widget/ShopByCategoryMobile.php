...
class ShopByCategoryMobile extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    protected $_categoryFactory;
    protected $_productCollectionFactory;
    protected $attribute;
    protected $attributeRepository;
    protected $_template = 'Digidirect_ShopByCategory::widget/shop-by-category-mobile.phtml';
