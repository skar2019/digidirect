...
class ProfileProduct extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Ced\MPCatch\Model\ResourceModel\ProfileProduct');
    }
    ...
    {
        return $this->getResource('Ced\MPCatch\Model\ResourceModel\ProfileProduct\Collection');
    }
     ...
     * @return bool|\Ced\MPCatch\Model\ProfileProduct
     */
