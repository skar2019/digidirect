...
class Sync extends Action
{
    ...
    public function __construct(
        ...
        \CatchSdk\ProductFactory $feedrequest,
        ...
        $this->mpcatchProducthelper = $product;
    ...
    public function execute()
    {
        ...
        if ($feed and $feed->getId()) {
            ...
            if($feed->getType()=='inventory-update')
                $feed_data = $this->feedrequest->create(['config' => $this->config->getApiConfig()])->getFeeds($feed->getFeedId() ,\CatchSdk\Core\Request::POST_OFFER_IMPORT.'/'.$feed->getFeedId());
            else
                $feed_data = $this->feedrequest->create(['config' => $this->config->getApiConfig()])->getFeeds($feed->getFeedId() ,\CatchSdk\Core\Request::POST_ITEMS_SUB_URL.'/'.$feed->getFeedId());

            $feedError = $this->mpcatchProducthelper->getFeeds($feed->getFeedId(), $feed_data);
