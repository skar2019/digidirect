...
class Delete extends Action
{
    ...
    public function __construct(
        ...
        $this->fileIo = $fileIo;
        $this->filter = $filter;
        $this->mpcatchFeeds = $mpcatchFeeds;
    }
    ...
    public function execute()
    {
        ...
        if (isset($isFilter)) {
            $collection = $this->filter->getCollection($this->mpcatchFeeds->getCollection());
        } else {
            $id = $this->getRequest()->getParam('id');
            if (isset($id) and !empty($id)) {
                $collection = $this->mpcatchFeeds->getCollection()->addFieldToFilter('id', ['eq' => $id]);
            }
        }
