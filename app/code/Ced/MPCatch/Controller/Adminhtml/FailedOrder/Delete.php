...
namespace Ced\MPCatch\Controller\Adminhtml\FailedOrder;
 ...
 * Class Delete
 *
 * @package Ced\MPCatch\Controller\Adminhtml\FailedOrder
 */
class Delete extends Action
{
     ...
     * @param \Ced\MPCatch\Model\OrderFailed           $orderFailed
     */
    public function __construct(
        Action\Context $context,
        PageFactory $resultPageFactory,
        \Magento\Ui\Component\MassAction\Filter $filter,
        \Ced\MPCatch\Model\OrderFailed $orderFailed
    ) {
    ...
    public function execute()
    {
        ...
        $this->_redirect('mpcatch/failedorder');
    }
}
