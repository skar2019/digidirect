...
namespace Ced\MPCatch\Block\Adminhtml\Profile\Edit\Tab;

use CatchSdk\Product;
...
class Mapping extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \CatchSdk\ProductFactory $product,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('category', ['legend' => __('Catch Category Listing')]);
        ...
        $locations->setRenderer(
            $this->getLayout()->createBlock('Ced\MPCatch\Block\Adminhtml\Profile\Edit\Tab\Attribute\CategoryJs')
        );

        $fieldset = $form->addFieldset(
            'attributes_fieldset',
            [
                'legend' => __('MPCatch Attributes Mapping')
            ]
        );
        ...
        $locations->setRenderer(
            $this->getLayout()->createBlock(
                'Ced\MPCatch\Block\Adminhtml\Profile\Edit\Tab\Attribute\Attributes',
                'mpcatch_attributes'
            )
        );
