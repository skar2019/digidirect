...
namespace Ced\MPCatch\Block\Adminhtml\Profile\Ui\View\Grid;
...
class Product extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Ced\MPCatch\Model\Source\Profiles $profiles,
        \Ced\MPCatch\Model\Source\Categories $categories,
        array $data = []
    )
    {
    ...
    {
        parent::_construct();
        $this->setId('mpcatch_profile_products');
    ...
    {
        return $this->_coreRegistry->registry('mpcatch_profile');
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'category_ids',
                'renderer' => 'Ced\MPCatch\Block\Adminhtml\Profile\Ui\View\Grid\Category',
