...
class ProfileProducts extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Ced_MPCatch::profile/profile_products.phtml';
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                \Ced\MPCatch\Block\Adminhtml\Profile\Ui\View\Grid\Product::class,
                'mpcatch.profile.products.grid'
            );
        }
 ...
 /**
    ...
    {
        return $this->registry->registry('mpcatch_profile');
    }
}
