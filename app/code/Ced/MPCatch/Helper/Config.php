...
class Config extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getHoldOrderUntilShipping()
    {
        $holdOrder = $this->scopeConfigManager
            ->getValue("mpcatch_config/mpcatch_order/hold_order_until_shipping");
        return $holdOrder;
    }
    ...
    public function getUseMsi()
    {
        $useMsi = $this->scopeConfigManager
            ->getValue("mpcatch_config/mpcatch_product/inventory_settings/use_msi");
        return $useMsi;
    }
    ...
    public function getMsiSourceCode()
    {
        $msiSourceCode = $this->scopeConfigManager
            ->getValue("mpcatch_config/mpcatch_product/inventory_settings/msi_source_code");
