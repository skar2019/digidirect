...
/**
 * Class Profile For MPCatch Profiling
 *
...
class Profile extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    */
    ...
    public function __construct(
        ...
        \Ced\MPCatch\Model\ProfileFactory $profile,
        \Ced\MPCatch\Helper\Cache $cache
    ) {
        $this->json = $json;
        $this->profileProduct = $profileProduct;
        $this->mpcatchCache = $cache;
     ...
     * @return \Ced\MPCatch\Helper\Profile|null
     */
    public function getProfile($productId = null, $profileId = null)
    {
        ...
        $this->profile = $this->mpcatchCache->getValue(\Ced\MPCatch\Helper\Cache::PROFILE_CACHE_KEY . $profileId);
    ...
    public function setProfile($profileId = null)
    {
        if (isset($profileId)) {
            ...
            if (isset($this->profile) and is_array($this->profile)) {
                ...
                $this->mpcatchCache->setValue(\Ced\MPCatch\Helper\Cache::PROFILE_CACHE_KEY . $profileId, $this->profile);
                return true;
            }
        }
        return false;
