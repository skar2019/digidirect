...
namespace Ced\MPCatch\Ui\Component\Listing\Columns\Order;
...
*/
    ...
    const URL_PATH_VIEW = 'mpcatch/order/view';
    const URL_PATH_SYNC = 'mpcatch/order/sync';
    const URL_PATH_DELETE = 'mpcatch/order/delete';
    const URL_PATH_DOWNLOAD = 'mpcatch/order/download';
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                if (isset($item['id'])) {
                    /*$item[$name]['view'] = [
                        ...
                        'popup' => [
                            'title' => __("MPCatch Order #{$item['magento_increment_id']}"),
