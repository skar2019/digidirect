...
namespace Ced\MPCatch\Ui\DataProvider\Profile\Form;
...
class DataProvider extends AbstractDataProvider
{
     ...
     * @param \Ced\MPCatch\Model\ResourceModel\Profile\CollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        $primaryFieldName,
        $requestFieldName,
        \Ced\MPCatch\Model\ResourceModel\Profile\CollectionFactory $collectionFactory,
    ...
    public function getData()
    {
        ...
        foreach ($items as $item) {
            ...
            $offers = [
                ...
                'profile_catch_club_eligible' => $item['profile_catch_club_eligible'],
            ];
            $data[$item['id']] = [
