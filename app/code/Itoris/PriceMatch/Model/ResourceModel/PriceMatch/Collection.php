    ...
    public function addItorisAttr()
    {
        ...
        $this->getSelect()->distinct()
            ->join(
                ...
                ['final_price'=>'IF(isnull(pm.old_price),IF(cpev.value IS NOT NULL OR cpev.value != 0, IF(price_index.final_price < cpev.value, price_index.final_price, cpev.value),price_index.final_price), pm.old_price)']
            )->join(
