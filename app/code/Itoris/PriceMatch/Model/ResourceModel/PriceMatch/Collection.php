    ...
    public function addItorisAttr()
    {
        ...
        $this->getSelect()->distinct()
            ->join(
                ...
                ['final_price'=>'IF(isnull(pm.old_price), IF(((price_index.final_price < CONVERT(cpev.value, DECIMAL)) OR isnull(cpev.value) OR cpev.value = 0) ,price_index.final_price, CONVERT(cpev.value, DECIMAL)), pm.old_price)']
            )->join(
