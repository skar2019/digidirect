    ...
    public function addItorisAttr()
    {
        ...
        $this->getSelect()->distinct()
            ->join(
                ...
                ['final_price'=>'IF(isnull(pm.old_price), IF((price_index.final_price < CONVERT(cpev.value, DECIMAL)),price_index.final_price,CONVERT(cpev.value, DECIMAL)),pm.old_price)']
            )->join(
