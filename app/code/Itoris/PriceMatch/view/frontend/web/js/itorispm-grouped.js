        ...
        $(function () {
                            ...
                            buttons: [
                                {
                                    ...
                                    click: function () {
                                        ...
                                        $(
                                            "#itoris-pm-link, #itoris-pm-link-custom"
            ...
            var updateFormPrice = function (newValue) {
                $("#itoris_pm_modal_final_price").text(
                    priceUtils.formatPrice(newValue, config["priceFormat"])
                );
            ...
            form.submit(function () {
                var checkValidName = true,
                    ...
                    checkValidPrice = $.validator.validateSingleElement(
                        document.getElementById("itoris_pm_modal_match_price")
                    ),
            ...
            $("div.table-wrapper.grouped table.grouped tbody")
                .find("tr td.item div.price-box")
                .each(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data["check_render_link"]) {
                                bootstrap(
                                    item,
                                    containersProductQty[currentProductId]
                                );
                            }
                        },
                    });
