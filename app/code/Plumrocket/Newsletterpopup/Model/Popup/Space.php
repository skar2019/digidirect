...
class Space extends AbstractModel
{
    ...
    public function getSpace()
    {
        ...
        $cart = [
            'quote'             => $quote,
            'cart_base_subtotal'=> round((int) $quote->getGrandTotal(), 2),
        ...
        // Product.
        if ($this->_request->getParam('productId')
            && $_product = $this->_productFactory->create()->load($this->_request->getParam('productId'))
        ) {
