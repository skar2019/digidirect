...
class Htmltoimage extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        if ($this->_adminhtmlHelper->checkIfHtmlToImageInstalled()) {
            ...
            <a href="https://plumrocket.com/docs/magento-newsletter-popup/v3/installation#Newsletter_Popup_Thumbnail_Generation" target="_blank">our online documentation</a> for more info.
            <br /><br />
