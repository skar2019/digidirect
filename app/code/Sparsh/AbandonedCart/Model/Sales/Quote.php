 ...
 */
namespace Sparsh\AbandonedCart\Model\Sales;

use Sparsh\AbandonedCart\Model\ResourceModel\Campaign;
...
{
    //customer
    const XML_PATH_LOSTBASKET_CUSTOMER_ENABLED_1 = 'sparsh_abandoned_cart/customers/enabled_1';

    const XML_PATH_LOSTBASKET_CUSTOMER_ENABLED_2 = 'sparsh_abandoned_cart/customers/enabled_2';

    const XML_PATH_LOSTBASKET_CUSTOMER_ENABLED_3 = 'sparsh_abandoned_cart/customers/enabled_3';

    const XML_PATH_LOSTBASKET_CUSTOMER_ENABLED_4 = 'sparsh_abandoned_cart/customers/enabled_4';

    const XML_PATH_LOSTBASKET_CUSTOMER_INTERVAL_1 = 'sparsh_abandoned_cart/customers/send_after_1';

    const XML_PATH_LOSTBASKET_CUSTOMER_INTERVAL_2 = 'sparsh_abandoned_cart/customers/send_after_2';

    const XML_PATH_LOSTBASKET_CUSTOMER_INTERVAL_3 = 'sparsh_abandoned_cart/customers/send_after_3';

    const XML_PATH_LOSTBASKET_CUSTOMER_INTERVAL_4 = 'sparsh_abandoned_cart/customers/send_after_4';

    const XML_PATH_LOSTBASKET_CUSTOMER_TEMPLATE_1 = 'sparsh_abandoned_cart/customers/template1';

    const XML_PATH_LOSTBASKET_CUSTOMER_TEMPLATE_2 = 'sparsh_abandoned_cart/customers/template2';

    const XML_PATH_LOSTBASKET_CUSTOMER_TEMPLATE_3 = 'sparsh_abandoned_cart/customers/template3';

    const XML_PATH_LOSTBASKET_CUSTOMER_TEMPLATE_4 = 'sparsh_abandoned_cart/customers/template4';

    //guest
    const XML_PATH_LOSTBASKET_GUEST_ENABLED_1 = 'sparsh_abandoned_cart/guests/enabled_1';

    const XML_PATH_LOSTBASKET_GUEST_ENABLED_2 = 'sparsh_abandoned_cart/guests/enabled_2';

    const XML_PATH_LOSTBASKET_GUEST_ENABLED_3 = 'sparsh_abandoned_cart/guests/enabled_3';

    const XML_PATH_LOSTBASKET_GUEST_ENABLED_4 = 'sparsh_abandoned_cart/guests/enabled_4';

    const XML_PATH_LOSTBASKET_GUEST_INTERVAL_1 = 'sparsh_abandoned_cart/guests/send_after_1';

    const XML_PATH_LOSTBASKET_GUEST_INTERVAL_2 = 'sparsh_abandoned_cart/guests/send_after_2';

    const XML_PATH_LOSTBASKET_GUEST_INTERVAL_3 = 'sparsh_abandoned_cart/guests/send_after_3';

    const XML_PATH_LOSTBASKET_GUEST_INTERVAL_4 = 'sparsh_abandoned_cart/guests/send_after_4';

    const XML_PATH_LOSTBASKET_GUEST_TEMPLATE_1 = 'sparsh_abandoned_cart/guests/template1';

    const XML_PATH_LOSTBASKET_GUEST_TEMPLATE_2 = 'sparsh_abandoned_cart/guests/template2';

    const XML_PATH_LOSTBASKET_GUEST_TEMPLATE_3 = 'sparsh_abandoned_cart/guests/template3';

    const XML_PATH_LOSTBASKET_GUEST_TEMPLATE_4 = 'sparsh_abandoned_cart/guests/template4';
     ...
     * Quote constructor.
     *
     * @param \Sparsh\AbandonedCart\Model\AbandonedFactory                          $abandonedFactory           abandonedFactory
     * @param Campaign\CollectionFactory                                                $campaignCollection         campaignCollection
     * @param Campaign                                                                  $campaignResource           campaignResource
     * @param \Sparsh\AbandonedCart\Model\CampaignFactory                           $campaignFactory            campaignFactory
     * @param \Sparsh\AbandonedCart\Helper\Data                                     $helper                     helper
     * @param \Sparsh\AbandonedCart\Model\ResourceModel\Abandoned\CollectionFactory $abandonedCollectionFactory abandonedCollectionFactory
     * @param \Sparsh\AbandonedCart\Model\ResourceModel\Abandoned                   $abandonedResource          abandonedResource
    ...
    public function __construct(
        \Sparsh\AbandonedCart\Model\AbandonedFactory $abandonedFactory,
        \Sparsh\AbandonedCart\Model\ResourceModel\Campaign\CollectionFactory $campaignCollection,
        \Sparsh\AbandonedCart\Model\ResourceModel\Campaign $campaignResource,
        \Sparsh\AbandonedCart\Model\CampaignFactory $campaignFactory,
        \Sparsh\AbandonedCart\Helper\Data $helper,
        \Sparsh\AbandonedCart\Model\ResourceModel\Abandoned\CollectionFactory $abandonedCollectionFactory,
        \Sparsh\AbandonedCart\Model\ResourceModel\Abandoned $abandonedResource,
    ...
    {
        $quoteUrl = $this->frameworkTemplate->getUrl('sparsh_abandoned_cart/cart/index', ['quote'=>$quote->getId()]);
