...
return [
    ...
    'modules' => [
        ...
        'Magezon_UiBuilder' => 1,
        'Marketplacer_Base' => 0,
        'Marketplacer_BrandApi' => 0,
        'Marketplacer_Brand' => 0,
        'Marketplacer_SellerApi' => 0,
        'Marketplacer_Seller' => 0,
        'Marketplacer_Marketplacer' => 0,
        'PayPal_Braintree' => 1,
        'OlegKoval_RegenerateUrlRewrites' => 0,
        'Onsport_CustomListing' => 0,
        'OuterEdge_StructuredData' => 0,
        'Marketplacer_SellerShipping' => 0,
