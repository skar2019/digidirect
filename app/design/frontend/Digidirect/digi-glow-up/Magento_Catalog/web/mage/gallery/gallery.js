    ...
    return Class.extend({
        ...
        initialize: function (config, element) {
            ...
            $(".fotorama__view--more").on("click", function () {
                ...
                $(".fotorama__stage__shaft").addClass(
                    "expanded parent-of-" + count
                );
                $(this).hide();
            ...
            $(".fotorama__view--less").on("click", function () {
                $(".fotorama__stage__shaft")[0].className = $(
                    ".fotorama__stage__shaft"
                )[0].className.replace(/\bparent-of-.*?\b/g, "");
            ...
            var settings = this.settings,
                ...
                api = {
                    ...
                    updateData: function (data) {
                        ...
                        if (count > 5) {
                            count = 5;
                            $(".fotorama__view--more").attr(
                                "style",
                                "display:block;"
                            );
                            $(".fotorama__view--less").attr(
                                "style",
                                "display:none;"
                            );
                        } else {
