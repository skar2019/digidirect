define(['module', 'exports', 'jquery', 'ewaveUtils', './truncate-collection/common/store', 'jquery/ui', 'truncateDotdotdot', 'domReady!'], function (module, exports, _jquery, _ewaveUtils, _store) {
    'use strict';
    ...
    _jquery2.default.widget('ewave.truncateCollection', {
        version: '0.0.1',
        options: {
        ...
        _loadAddOn: function _loadAddOn() {
            var options = this.options,
                store = this.store,
                events = this.events;
            (0, _ewaveUtils.loadAddOn)({ options: options, store: store, events: events }, this, 'Truncate Collection');
            return this;
        },
        ...
        getRawСollection: function getRawOllection() {
            return (0, _jquery2.default)(this.element).find(this.options.selector).not(':ewave-truncateDotdotdot');
        },
    ...
    exports.default = _jquery2.default.ewave.truncateCollection;
