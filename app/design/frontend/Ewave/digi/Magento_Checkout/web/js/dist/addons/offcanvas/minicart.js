define(['module', 'exports', 'ewaveStoreCheckout'], function (module, exports, _ewaveStoreCheckout) {
    'use strict';
    ...
    var AddOn = function AddOn(_ref) {
        ...
        _ewaveStoreCheckout.Store.on(_ewaveStoreCheckout.Events.MINICART_TOGGLE, function (data, state) {
            _this.Store.emit(_this.Events.OFFCANVAS_TOOGLE, data || _this.element, state || _this.Store.currentState);
        });
        _ewaveStoreCheckout.Store.on(_ewaveStoreCheckout.Events.MINICART_OPEN, function (data) {
            _this.Store.emit(_this.Events.OFFCANVAS_OPEN, data || _this.element);
        });
        _ewaveStoreCheckout.Store.on(_ewaveStoreCheckout.Events.MINICART_CLOSE, function (data) {
